...
func (x *AdGroupSimulation) Reset() {
	*x = AdGroupSimulation{}
	mi := &file_google_ads_googleads_v21_resources_ad_group_simulation_proto_msgTypes[0]
...
func (*AdGroupSimulation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v21_resources_ad_group_simulation_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDesc = string([]byte{
...
var (
	file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDesc), len(file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_ad_group_simulation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_resources_ad_group_simulation_proto_goTypes = []any{
	(*AdGroupSimulation)(nil),                                                // 0: google.ads.googleads.v21.resources.AdGroupSimulation
	...
	(*common.CpvBidSimulationPointList)(nil),                                 // 4: google.ads.googleads.v21.common.CpvBidSimulationPointList
	(*common.TargetCpaSimulationPointList)(nil),                              // 5: google.ads.googleads.v21.common.TargetCpaSimulationPointList
	(*common.TargetRoasSimulationPointList)(nil),                             // 6: google.ads.googleads.v21.common.TargetRoasSimulationPointList
}
var file_google_ads_googleads_v21_resources_ad_group_simulation_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.AdGroupSimulation.type:type_name -> google.ads.googleads.v21.enums.SimulationTypeEnum.SimulationType
	2, // 1: google.ads.googleads.v21.resources.AdGroupSimulation.modification_method:type_name -> google.ads.googleads.v21.enums.SimulationModificationMethodEnum.SimulationModificationMethod
	3, // 2: google.ads.googleads.v21.resources.AdGroupSimulation.cpc_bid_point_list:type_name -> google.ads.googleads.v21.common.CpcBidSimulationPointList
	4, // 3: google.ads.googleads.v21.resources.AdGroupSimulation.cpv_bid_point_list:type_name -> google.ads.googleads.v21.common.CpvBidSimulationPointList
	5, // 4: google.ads.googleads.v21.resources.AdGroupSimulation.target_cpa_point_list:type_name -> google.ads.googleads.v21.common.TargetCpaSimulationPointList
	6, // 5: google.ads.googleads.v21.resources.AdGroupSimulation.target_roas_point_list:type_name -> google.ads.googleads.v21.common.TargetRoasSimulationPointList
...
func init() { file_google_ads_googleads_v21_resources_ad_group_simulation_proto_init() }
func file_google_ads_googleads_v21_resources_ad_group_simulation_proto_init() {
	if File_google_ads_googleads_v21_resources_ad_group_simulation_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_ad_group_simulation_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDesc), len(file_google_ads_googleads_v21_resources_ad_group_simulation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_ad_group_simulation_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_ad_group_simulation_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_ad_group_simulation_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_ad_group_simulation_proto = out.File
	file_google_ads_googleads_v21_resources_ad_group_simulation_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_ad_group_simulation_proto_depIdxs = nil
}
