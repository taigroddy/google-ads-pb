...
const (
	BiddingSeasonalityAdjustmentService_MutateBiddingSeasonalityAdjustments_FullMethodName = "/google.ads.googleads.v21.services.BiddingSeasonalityAdjustmentService/MutateBiddingSeasonalityAdjustments"
)
...
// UnimplementedBiddingSeasonalityAdjustmentServiceServer must be embedded to have
...
func (UnimplementedBiddingSeasonalityAdjustmentServiceServer) testEmbeddedByValue() {}
...
func RegisterBiddingSeasonalityAdjustmentServiceServer(s grpc.ServiceRegistrar, srv BiddingSeasonalityAdjustmentServiceServer) {
	// If the following call pancis, it indicates UnimplementedBiddingSeasonalityAdjustmentServiceServer was
...
var BiddingSeasonalityAdjustmentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v21.services.BiddingSeasonalityAdjustmentService",
	...
	Metadata: "google/ads/googleads/v21/services/bidding_seasonality_adjustment_service.proto",
}
