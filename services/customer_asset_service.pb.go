...
func (x *MutateCustomerAssetsRequest) Reset() {
	*x = MutateCustomerAssetsRequest{}
	mi := &file_google_ads_googleads_v21_services_customer_asset_service_proto_msgTypes[0]
...
func (*MutateCustomerAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerAssetOperation) Reset() {
	*x = CustomerAssetOperation{}
	mi := &file_google_ads_googleads_v21_services_customer_asset_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerAssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerAssetOperation) GetOperation() isCustomerAssetOperation_Operation {
	if x != nil {
		return x.Operation
	}
	return nil
...
func (x *CustomerAssetOperation) GetCreate() *resources.CustomerAsset {
	if x != nil {
		if x, ok := x.Operation.(*CustomerAssetOperation_Create); ok {
			return x.Create
		}
	}
	return nil
...
func (x *CustomerAssetOperation) GetUpdate() *resources.CustomerAsset {
	if x != nil {
		if x, ok := x.Operation.(*CustomerAssetOperation_Update); ok {
			return x.Update
		}
	}
	return nil
...
func (x *CustomerAssetOperation) GetRemove() string {
	if x != nil {
		if x, ok := x.Operation.(*CustomerAssetOperation_Remove); ok {
			return x.Remove
		}
	}
	return ""
...
func (x *MutateCustomerAssetsResponse) Reset() {
	*x = MutateCustomerAssetsResponse{}
	mi := &file_google_ads_googleads_v21_services_customer_asset_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerAssetResult) Reset() {
	*x = MutateCustomerAssetResult{}
	mi := &file_google_ads_googleads_v21_services_customer_asset_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v21_services_customer_asset_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDesc = string([]byte{
	...
	0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x19, 0x43, 0x75, 0x73, 0x74,
...
var (
	file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_customer_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v21_services_customer_asset_service_proto_goTypes = []any{
	(*MutateCustomerAssetsRequest)(nil),                    // 0: google.ads.googleads.v21.services.MutateCustomerAssetsRequest
	(*CustomerAssetOperation)(nil),                         // 1: google.ads.googleads.v21.services.CustomerAssetOperation
	(*MutateCustomerAssetsResponse)(nil),                   // 2: google.ads.googleads.v21.services.MutateCustomerAssetsResponse
	(*MutateCustomerAssetResult)(nil),                      // 3: google.ads.googleads.v21.services.MutateCustomerAssetResult
	...
	(*resources.CustomerAsset)(nil),                        // 6: google.ads.googleads.v21.resources.CustomerAsset
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v21_services_customer_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.services.MutateCustomerAssetsRequest.operations:type_name -> google.ads.googleads.v21.services.CustomerAssetOperation
	4, // 1: google.ads.googleads.v21.services.MutateCustomerAssetsRequest.response_content_type:type_name -> google.ads.googleads.v21.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v21.services.CustomerAssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v21.services.CustomerAssetOperation.create:type_name -> google.ads.googleads.v21.resources.CustomerAsset
	6, // 4: google.ads.googleads.v21.services.CustomerAssetOperation.update:type_name -> google.ads.googleads.v21.resources.CustomerAsset
	7, // 5: google.ads.googleads.v21.services.MutateCustomerAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v21.services.MutateCustomerAssetsResponse.results:type_name -> google.ads.googleads.v21.services.MutateCustomerAssetResult
	6, // 7: google.ads.googleads.v21.services.MutateCustomerAssetResult.customer_asset:type_name -> google.ads.googleads.v21.resources.CustomerAsset
	0, // 8: google.ads.googleads.v21.services.CustomerAssetService.MutateCustomerAssets:input_type -> google.ads.googleads.v21.services.MutateCustomerAssetsRequest
	2, // 9: google.ads.googleads.v21.services.CustomerAssetService.MutateCustomerAssets:output_type -> google.ads.googleads.v21.services.MutateCustomerAssetsResponse
...
func init() { file_google_ads_googleads_v21_services_customer_asset_service_proto_init() }
func file_google_ads_googleads_v21_services_customer_asset_service_proto_init() {
	if File_google_ads_googleads_v21_services_customer_asset_service_proto != nil {
		return
	}
	file_google_ads_googleads_v21_services_customer_asset_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_customer_asset_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_customer_asset_service_proto_goTypes,
	...
	File_google_ads_googleads_v21_services_customer_asset_service_proto = out.File
	file_google_ads_googleads_v21_services_customer_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_customer_asset_service_proto_depIdxs = nil
}
