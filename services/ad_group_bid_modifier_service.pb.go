...
func (x *MutateAdGroupBidModifiersRequest) Reset() {
	*x = MutateAdGroupBidModifiersRequest{}
	mi := &file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_msgTypes[0]
...
func (*MutateAdGroupBidModifiersRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupBidModifierOperation) Reset() {
	*x = AdGroupBidModifierOperation{}
	mi := &file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdGroupBidModifierOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupBidModifiersResponse) Reset() {
	*x = MutateAdGroupBidModifiersResponse{}
	mi := &file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupBidModifiersResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupBidModifierResult) Reset() {
	*x = MutateAdGroupBidModifierResult{}
	mi := &file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupBidModifierResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDesc = string([]byte{
	...
	0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x3a, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x31, 0x39, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x72, 0x65, 0x73, 0x70, 0x6f,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x3e, 0x3a, 0x01, 0x2a, 0x22, 0x39, 0x2f, 0x76, 0x31, 0x39, 0x2f, 0x63,
	...
	0x31, 0x39, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0xca, 0x02, 0x21, 0x47, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41,
	0x64, 0x73, 0x5c, 0x56, 0x31, 0x39, 0x5c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0xea,
	0x02, 0x25, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x31, 0x39, 0x3a, 0x3a, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDescData
}

var file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_goTypes = []any{
	(*MutateAdGroupBidModifiersRequest)(nil),               // 0: google.ads.googleads.v19.services.MutateAdGroupBidModifiersRequest
	(*AdGroupBidModifierOperation)(nil),                    // 1: google.ads.googleads.v19.services.AdGroupBidModifierOperation
	(*MutateAdGroupBidModifiersResponse)(nil),              // 2: google.ads.googleads.v19.services.MutateAdGroupBidModifiersResponse
	(*MutateAdGroupBidModifierResult)(nil),                 // 3: google.ads.googleads.v19.services.MutateAdGroupBidModifierResult
	...
	(*resources.AdGroupBidModifier)(nil),                   // 6: google.ads.googleads.v19.resources.AdGroupBidModifier
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v19.services.MutateAdGroupBidModifiersRequest.operations:type_name -> google.ads.googleads.v19.services.AdGroupBidModifierOperation
	4, // 1: google.ads.googleads.v19.services.MutateAdGroupBidModifiersRequest.response_content_type:type_name -> google.ads.googleads.v19.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v19.services.AdGroupBidModifierOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v19.services.AdGroupBidModifierOperation.create:type_name -> google.ads.googleads.v19.resources.AdGroupBidModifier
	6, // 4: google.ads.googleads.v19.services.AdGroupBidModifierOperation.update:type_name -> google.ads.googleads.v19.resources.AdGroupBidModifier
	7, // 5: google.ads.googleads.v19.services.MutateAdGroupBidModifiersResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v19.services.MutateAdGroupBidModifiersResponse.results:type_name -> google.ads.googleads.v19.services.MutateAdGroupBidModifierResult
	6, // 7: google.ads.googleads.v19.services.MutateAdGroupBidModifierResult.ad_group_bid_modifier:type_name -> google.ads.googleads.v19.resources.AdGroupBidModifier
	0, // 8: google.ads.googleads.v19.services.AdGroupBidModifierService.MutateAdGroupBidModifiers:input_type -> google.ads.googleads.v19.services.MutateAdGroupBidModifiersRequest
	2, // 9: google.ads.googleads.v19.services.AdGroupBidModifierService.MutateAdGroupBidModifiers:output_type -> google.ads.googleads.v19.services.MutateAdGroupBidModifiersResponse
...
func init() { file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_init() }
func file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_init() {
	if File_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto != nil {
		return
	}
	file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto = out.File
	file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_goTypes = nil
	file_google_ads_googleads_v19_services_ad_group_bid_modifier_service_proto_depIdxs = nil
}
