...
func (x *SuggestGeoTargetConstantsRequest) Reset() {
	*x = SuggestGeoTargetConstantsRequest{}
	mi := &file_google_ads_googleads_v19_services_geo_target_constant_service_proto_msgTypes[0]
...
func (*SuggestGeoTargetConstantsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SuggestGeoTargetConstantsResponse) Reset() {
	*x = SuggestGeoTargetConstantsResponse{}
	mi := &file_google_ads_googleads_v19_services_geo_target_constant_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SuggestGeoTargetConstantsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *GeoTargetConstantSuggestion) Reset() {
	*x = GeoTargetConstantSuggestion{}
	mi := &file_google_ads_googleads_v19_services_geo_target_constant_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GeoTargetConstantSuggestion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *SuggestGeoTargetConstantsRequest_LocationNames) Reset() {
	*x = SuggestGeoTargetConstantsRequest_LocationNames{}
	mi := &file_google_ads_googleads_v19_services_geo_target_constant_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SuggestGeoTargetConstantsRequest_LocationNames) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SuggestGeoTargetConstantsRequest_GeoTargets) Reset() {
	*x = SuggestGeoTargetConstantsRequest_GeoTargets{}
	mi := &file_google_ads_googleads_v19_services_geo_target_constant_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SuggestGeoTargetConstantsRequest_GeoTargets) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDescGZIP(), []int{0, 1}
}
...
var File_google_ads_googleads_v19_services_geo_target_constant_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDesc = string([]byte{
	...
	0x31, 0x39, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x67, 0x65, 0x6f,
	...
	0x76, 0x31, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x75, 0x67,
	...
	0x2a, 0x22, 0x1f, 0x2f, 0x76, 0x31, 0x39, 0x2f, 0x67, 0x65, 0x6f, 0x54, 0x61, 0x72, 0x67, 0x65,
	...
	0x5c, 0x56, 0x31, 0x39, 0x5c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0xea, 0x02, 0x25,
	0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x31, 0x39, 0x3a, 0x3a, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDescData
}

var file_google_ads_googleads_v19_services_geo_target_constant_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v19_services_geo_target_constant_service_proto_goTypes = []any{
	(*SuggestGeoTargetConstantsRequest)(nil),               // 0: google.ads.googleads.v19.services.SuggestGeoTargetConstantsRequest
	(*SuggestGeoTargetConstantsResponse)(nil),              // 1: google.ads.googleads.v19.services.SuggestGeoTargetConstantsResponse
	(*GeoTargetConstantSuggestion)(nil),                    // 2: google.ads.googleads.v19.services.GeoTargetConstantSuggestion
	(*SuggestGeoTargetConstantsRequest_LocationNames)(nil), // 3: google.ads.googleads.v19.services.SuggestGeoTargetConstantsRequest.LocationNames
	(*SuggestGeoTargetConstantsRequest_GeoTargets)(nil),    // 4: google.ads.googleads.v19.services.SuggestGeoTargetConstantsRequest.GeoTargets
	(*resources.GeoTargetConstant)(nil),                    // 5: google.ads.googleads.v19.resources.GeoTargetConstant
}
var file_google_ads_googleads_v19_services_geo_target_constant_service_proto_depIdxs = []int32{
	3, // 0: google.ads.googleads.v19.services.SuggestGeoTargetConstantsRequest.location_names:type_name -> google.ads.googleads.v19.services.SuggestGeoTargetConstantsRequest.LocationNames
	4, // 1: google.ads.googleads.v19.services.SuggestGeoTargetConstantsRequest.geo_targets:type_name -> google.ads.googleads.v19.services.SuggestGeoTargetConstantsRequest.GeoTargets
	2, // 2: google.ads.googleads.v19.services.SuggestGeoTargetConstantsResponse.geo_target_constant_suggestions:type_name -> google.ads.googleads.v19.services.GeoTargetConstantSuggestion
	5, // 3: google.ads.googleads.v19.services.GeoTargetConstantSuggestion.geo_target_constant:type_name -> google.ads.googleads.v19.resources.GeoTargetConstant
	5, // 4: google.ads.googleads.v19.services.GeoTargetConstantSuggestion.geo_target_constant_parents:type_name -> google.ads.googleads.v19.resources.GeoTargetConstant
	0, // 5: google.ads.googleads.v19.services.GeoTargetConstantService.SuggestGeoTargetConstants:input_type -> google.ads.googleads.v19.services.SuggestGeoTargetConstantsRequest
	1, // 6: google.ads.googleads.v19.services.GeoTargetConstantService.SuggestGeoTargetConstants:output_type -> google.ads.googleads.v19.services.SuggestGeoTargetConstantsResponse
...
func init() { file_google_ads_googleads_v19_services_geo_target_constant_service_proto_init() }
func file_google_ads_googleads_v19_services_geo_target_constant_service_proto_init() {
	if File_google_ads_googleads_v19_services_geo_target_constant_service_proto != nil {
		return
	}
	file_google_ads_googleads_v19_services_geo_target_constant_service_proto_msgTypes[0].OneofWrappers = []any{
		(*SuggestGeoTargetConstantsRequest_LocationNames_)(nil),
		(*SuggestGeoTargetConstantsRequest_GeoTargets_)(nil),
	}
	file_google_ads_googleads_v19_services_geo_target_constant_service_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_geo_target_constant_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v19_services_geo_target_constant_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_services_geo_target_constant_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_services_geo_target_constant_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_services_geo_target_constant_service_proto = out.File
	file_google_ads_googleads_v19_services_geo_target_constant_service_proto_goTypes = nil
	file_google_ads_googleads_v19_services_geo_target_constant_service_proto_depIdxs = nil
}
