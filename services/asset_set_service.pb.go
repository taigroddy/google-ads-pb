...
func (x *MutateAssetSetsRequest) Reset() {
	*x = MutateAssetSetsRequest{}
	mi := &file_google_ads_googleads_v19_services_asset_set_service_proto_msgTypes[0]
...
func (*MutateAssetSetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_asset_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetSetOperation) Reset() {
	*x = AssetSetOperation{}
	mi := &file_google_ads_googleads_v19_services_asset_set_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AssetSetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_asset_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAssetSetsResponse) Reset() {
	*x = MutateAssetSetsResponse{}
	mi := &file_google_ads_googleads_v19_services_asset_set_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAssetSetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_asset_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetSetResult) Reset() {
	*x = MutateAssetSetResult{}
	mi := &file_google_ads_googleads_v19_services_asset_set_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAssetSetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_asset_set_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v19_services_asset_set_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_services_asset_set_service_proto_rawDesc = string([]byte{
	...
	0x34, 0x3a, 0x01, 0x2a, 0x22, 0x2f, 0x2f, 0x76, 0x31, 0x39, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f,
...
var (
	file_google_ads_googleads_v19_services_asset_set_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_services_asset_set_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_services_asset_set_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_services_asset_set_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_services_asset_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_asset_set_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_asset_set_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_services_asset_set_service_proto_rawDescData
}

var file_google_ads_googleads_v19_services_asset_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v19_services_asset_set_service_proto_goTypes = []any{
	(*MutateAssetSetsRequest)(nil),                         // 0: google.ads.googleads.v19.services.MutateAssetSetsRequest
	(*AssetSetOperation)(nil),                              // 1: google.ads.googleads.v19.services.AssetSetOperation
	(*MutateAssetSetsResponse)(nil),                        // 2: google.ads.googleads.v19.services.MutateAssetSetsResponse
	(*MutateAssetSetResult)(nil),                           // 3: google.ads.googleads.v19.services.MutateAssetSetResult
	...
	(*resources.AssetSet)(nil),                             // 6: google.ads.googleads.v19.resources.AssetSet
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v19_services_asset_set_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v19.services.MutateAssetSetsRequest.operations:type_name -> google.ads.googleads.v19.services.AssetSetOperation
	4, // 1: google.ads.googleads.v19.services.MutateAssetSetsRequest.response_content_type:type_name -> google.ads.googleads.v19.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v19.services.AssetSetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v19.services.AssetSetOperation.create:type_name -> google.ads.googleads.v19.resources.AssetSet
	6, // 4: google.ads.googleads.v19.services.AssetSetOperation.update:type_name -> google.ads.googleads.v19.resources.AssetSet
	3, // 5: google.ads.googleads.v19.services.MutateAssetSetsResponse.results:type_name -> google.ads.googleads.v19.services.MutateAssetSetResult
	7, // 6: google.ads.googleads.v19.services.MutateAssetSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	6, // 7: google.ads.googleads.v19.services.MutateAssetSetResult.asset_set:type_name -> google.ads.googleads.v19.resources.AssetSet
	0, // 8: google.ads.googleads.v19.services.AssetSetService.MutateAssetSets:input_type -> google.ads.googleads.v19.services.MutateAssetSetsRequest
	2, // 9: google.ads.googleads.v19.services.AssetSetService.MutateAssetSets:output_type -> google.ads.googleads.v19.services.MutateAssetSetsResponse
...
func init() { file_google_ads_googleads_v19_services_asset_set_service_proto_init() }
func file_google_ads_googleads_v19_services_asset_set_service_proto_init() {
	if File_google_ads_googleads_v19_services_asset_set_service_proto != nil {
		return
	}
	file_google_ads_googleads_v19_services_asset_set_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_asset_set_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_asset_set_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v19_services_asset_set_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_services_asset_set_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_services_asset_set_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_services_asset_set_service_proto = out.File
	file_google_ads_googleads_v19_services_asset_set_service_proto_goTypes = nil
	file_google_ads_googleads_v19_services_asset_set_service_proto_depIdxs = nil
}
