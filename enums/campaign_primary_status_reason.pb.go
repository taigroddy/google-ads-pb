...
const (
	...
	// targeting.
	CampaignPrimaryStatusReasonEnum_MISSING_LOCATION_TARGETING CampaignPrimaryStatusReasonEnum_CampaignPrimaryStatusReason = 39
)
...
func (CampaignPrimaryStatusReasonEnum_CampaignPrimaryStatusReason) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_enumTypes[0].Descriptor()
}

func (CampaignPrimaryStatusReasonEnum_CampaignPrimaryStatusReason) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_enumTypes[0]
}
...
func (CampaignPrimaryStatusReasonEnum_CampaignPrimaryStatusReason) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CampaignPrimaryStatusReasonEnum) Reset() {
	*x = CampaignPrimaryStatusReasonEnum{}
	mi := &file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_msgTypes[0]
...
func (*CampaignPrimaryStatusReasonEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDesc = string([]byte{
	...
	0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x92, 0x09, 0x0a, 0x1f, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69,
	0x67, 0x6e, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x65, 0x61, 0x73, 0x6f, 0x6e, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0xee, 0x08, 0x0a, 0x1b, 0x43, 0x61,
	...
	0x53, 0x5f, 0x50, 0x41, 0x55, 0x53, 0x45, 0x44, 0x10, 0x26, 0x12, 0x1e, 0x0a, 0x1a, 0x4d, 0x49,
	0x53, 0x53, 0x49, 0x4e, 0x47, 0x5f, 0x4c, 0x4f, 0x43, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x54,
	0x41, 0x52, 0x47, 0x45, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x27, 0x42, 0xfa, 0x01, 0x0a, 0x22, 0x63,
...
var (
	file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDesc), len(file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDescData
}

var file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_goTypes = []any{
	(CampaignPrimaryStatusReasonEnum_CampaignPrimaryStatusReason)(0), // 0: google.ads.googleads.v21.enums.CampaignPrimaryStatusReasonEnum.CampaignPrimaryStatusReason
	(*CampaignPrimaryStatusReasonEnum)(nil),                          // 1: google.ads.googleads.v21.enums.CampaignPrimaryStatusReasonEnum
}
var file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_init() }
func file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_init() {
	if File_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDesc), len(file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_depIdxs,
	...
	File_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto = out.File
	file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_goTypes = nil
	file_google_ads_googleads_v21_enums_campaign_primary_status_reason_proto_depIdxs = nil
}
