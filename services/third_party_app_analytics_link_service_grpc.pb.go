...
// UnimplementedThirdPartyAppAnalyticsLinkServiceServer must be embedded to have
...
func (UnimplementedThirdPartyAppAnalyticsLinkServiceServer) testEmbeddedByValue() {}
...
func RegisterThirdPartyAppAnalyticsLinkServiceServer(s grpc.ServiceRegistrar, srv ThirdPartyAppAnalyticsLinkServiceServer) {
	// If the following call pancis, it indicates UnimplementedThirdPartyAppAnalyticsLinkServiceServer was
