...
func (AssetPerformanceLabelEnum_AssetPerformanceLabel) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_enums_asset_performance_label_proto_enumTypes[0].Descriptor()
}

func (AssetPerformanceLabelEnum_AssetPerformanceLabel) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_enums_asset_performance_label_proto_enumTypes[0]
}
...
func (AssetPerformanceLabelEnum_AssetPerformanceLabel) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AssetPerformanceLabelEnum) Reset() {
	*x = AssetPerformanceLabelEnum{}
	mi := &file_google_ads_googleads_v21_enums_asset_performance_label_proto_msgTypes[0]
...
func (*AssetPerformanceLabelEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v21_enums_asset_performance_label_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDesc = string([]byte{
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x8a,
...
var (
	file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDesc), len(file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDescData
}

var file_google_ads_googleads_v21_enums_asset_performance_label_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_enums_asset_performance_label_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_enums_asset_performance_label_proto_goTypes = []any{
	(AssetPerformanceLabelEnum_AssetPerformanceLabel)(0), // 0: google.ads.googleads.v21.enums.AssetPerformanceLabelEnum.AssetPerformanceLabel
	(*AssetPerformanceLabelEnum)(nil),                    // 1: google.ads.googleads.v21.enums.AssetPerformanceLabelEnum
}
var file_google_ads_googleads_v21_enums_asset_performance_label_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v21_enums_asset_performance_label_proto_init() }
func file_google_ads_googleads_v21_enums_asset_performance_label_proto_init() {
	if File_google_ads_googleads_v21_enums_asset_performance_label_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDesc), len(file_google_ads_googleads_v21_enums_asset_performance_label_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_enums_asset_performance_label_proto_goTypes,
		...
		MessageInfos:      file_google_ads_googleads_v21_enums_asset_performance_label_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_enums_asset_performance_label_proto = out.File
	file_google_ads_googleads_v21_enums_asset_performance_label_proto_goTypes = nil
	file_google_ads_googleads_v21_enums_asset_performance_label_proto_depIdxs = nil
}
