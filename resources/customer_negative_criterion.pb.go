...
type CustomerNegativeCriterion struct {
	...
	Type enums.CriterionTypeEnum_CriterionType `protobuf:"varint,3,opt,name=type,proto3,enum=google.ads.googleads.v21.enums.CriterionTypeEnum_CriterionType" json:"type,omitempty"`
	...
	//	*CustomerNegativeCriterion_PlacementList
...
func (x *CustomerNegativeCriterion) Reset() {
	*x = CustomerNegativeCriterion{}
	mi := &file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_msgTypes[0]
...
func (*CustomerNegativeCriterion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerNegativeCriterion) GetPlacementList() *common.PlacementListInfo {
	if x != nil {
		if x, ok := x.Criterion.(*CustomerNegativeCriterion_PlacementList); ok {
			return x.PlacementList
		}
	}
	return nil
}
...
type CustomerNegativeCriterion_PlacementList struct {
	// Immutable. PlacementList.
	PlacementList *common.PlacementListInfo `protobuf:"bytes,13,opt,name=placement_list,json=placementList,proto3,oneof"`
}
...
func (*CustomerNegativeCriterion_PlacementList) isCustomerNegativeCriterion_Criterion() {}

var File_google_ads_googleads_v21_resources_customer_negative_criterion_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDesc = string([]byte{
	...
	0x2f, 0x76, 0x32, 0x31, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x63, 0x72, 0x69, 0x74,
	0x65, 0x72, 0x69, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x33, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x32, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x72, 0x69, 0x74, 0x65,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfa, 0x09, 0x0a, 0x19,
	...
	0x2e, 0x76, 0x32, 0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4d, 0x6f, 0x62, 0x69,
	...
	0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x59, 0x6f, 0x75, 0x54, 0x75, 0x62, 0x65,
	...
	0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x49, 0x70, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x03, 0xe0, 0x41, 0x05, 0x48, 0x00, 0x52,
	0x07, 0x69, 0x70, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x60, 0x0a, 0x0e, 0x70, 0x6c, 0x61, 0x63,
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b,
	...
	0x6f, 0x6e, 0x2e, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74,
	0x49, 0x6e, 0x66, 0x6f, 0x42, 0x03, 0xe0, 0x41, 0x05, 0x48, 0x00, 0x52, 0x0d, 0x70, 0x6c, 0x61,
	0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x3a, 0x78, 0xea, 0x41, 0x75, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x3f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f, 0x7b,
	...
	0x74, 0x65, 0x72, 0x69, 0x61, 0x2f, 0x7b, 0x63, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x6f, 0x6e,
	0x5f, 0x69, 0x64, 0x7d, 0x42, 0x0b, 0x0a, 0x09, 0x63, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x6f,
	0x6e, 0x42, 0x05, 0x0a, 0x03, 0x5f, 0x69, 0x64, 0x42, 0x90, 0x02, 0x0a, 0x26, 0x63, 0x6f, 0x6d,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x73, 0x42, 0x1e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x4e, 0x65, 0x67,
	0x61, 0x74, 0x69, 0x76, 0x65, 0x43, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x6f, 0x6e, 0x50, 0x72,
...
var (
	file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDesc), len(file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_goTypes = []any{
	(*CustomerNegativeCriterion)(nil),          // 0: google.ads.googleads.v21.resources.CustomerNegativeCriterion
	(enums.CriterionTypeEnum_CriterionType)(0), // 1: google.ads.googleads.v21.enums.CriterionTypeEnum.CriterionType
	(*common.ContentLabelInfo)(nil),            // 2: google.ads.googleads.v21.common.ContentLabelInfo
	(*common.MobileApplicationInfo)(nil),       // 3: google.ads.googleads.v21.common.MobileApplicationInfo
	(*common.MobileAppCategoryInfo)(nil),       // 4: google.ads.googleads.v21.common.MobileAppCategoryInfo
	(*common.PlacementInfo)(nil),               // 5: google.ads.googleads.v21.common.PlacementInfo
	(*common.YouTubeVideoInfo)(nil),            // 6: google.ads.googleads.v21.common.YouTubeVideoInfo
	(*common.YouTubeChannelInfo)(nil),          // 7: google.ads.googleads.v21.common.YouTubeChannelInfo
	(*common.NegativeKeywordListInfo)(nil),     // 8: google.ads.googleads.v21.common.NegativeKeywordListInfo
	(*common.IpBlockInfo)(nil),                 // 9: google.ads.googleads.v21.common.IpBlockInfo
	(*common.PlacementListInfo)(nil),           // 10: google.ads.googleads.v21.common.PlacementListInfo
}
var file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_depIdxs = []int32{
	1,  // 0: google.ads.googleads.v21.resources.CustomerNegativeCriterion.type:type_name -> google.ads.googleads.v21.enums.CriterionTypeEnum.CriterionType
	2,  // 1: google.ads.googleads.v21.resources.CustomerNegativeCriterion.content_label:type_name -> google.ads.googleads.v21.common.ContentLabelInfo
	3,  // 2: google.ads.googleads.v21.resources.CustomerNegativeCriterion.mobile_application:type_name -> google.ads.googleads.v21.common.MobileApplicationInfo
	4,  // 3: google.ads.googleads.v21.resources.CustomerNegativeCriterion.mobile_app_category:type_name -> google.ads.googleads.v21.common.MobileAppCategoryInfo
	5,  // 4: google.ads.googleads.v21.resources.CustomerNegativeCriterion.placement:type_name -> google.ads.googleads.v21.common.PlacementInfo
	6,  // 5: google.ads.googleads.v21.resources.CustomerNegativeCriterion.youtube_video:type_name -> google.ads.googleads.v21.common.YouTubeVideoInfo
	7,  // 6: google.ads.googleads.v21.resources.CustomerNegativeCriterion.youtube_channel:type_name -> google.ads.googleads.v21.common.YouTubeChannelInfo
	8,  // 7: google.ads.googleads.v21.resources.CustomerNegativeCriterion.negative_keyword_list:type_name -> google.ads.googleads.v21.common.NegativeKeywordListInfo
	9,  // 8: google.ads.googleads.v21.resources.CustomerNegativeCriterion.ip_block:type_name -> google.ads.googleads.v21.common.IpBlockInfo
	10, // 9: google.ads.googleads.v21.resources.CustomerNegativeCriterion.placement_list:type_name -> google.ads.googleads.v21.common.PlacementListInfo
...
func init() { file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_init() }
func file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_init() {
	if File_google_ads_googleads_v21_resources_customer_negative_criterion_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*CustomerNegativeCriterion_PlacementList)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDesc), len(file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_customer_negative_criterion_proto = out.File
	file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_customer_negative_criterion_proto_depIdxs = nil
}
