...
type GeoTargetConstant struct {
	...
	Status enums.GeoTargetConstantStatusEnum_GeoTargetConstantStatus `protobuf:"varint,7,opt,name=status,proto3,enum=google.ads.googleads.v21.enums.GeoTargetConstantStatusEnum_GeoTargetConstantStatus" json:"status,omitempty"`
...
func (x *GeoTargetConstant) Reset() {
	*x = GeoTargetConstant{}
	mi := &file_google_ads_googleads_v21_resources_geo_target_constant_proto_msgTypes[0]
...
func (*GeoTargetConstant) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v21_resources_geo_target_constant_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDesc = string([]byte{
...
var (
	file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDesc), len(file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_geo_target_constant_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_resources_geo_target_constant_proto_goTypes = []any{
	(*GeoTargetConstant)(nil),                                      // 0: google.ads.googleads.v21.resources.GeoTargetConstant
	(enums.GeoTargetConstantStatusEnum_GeoTargetConstantStatus)(0), // 1: google.ads.googleads.v21.enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus
}
var file_google_ads_googleads_v21_resources_geo_target_constant_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.GeoTargetConstant.status:type_name -> google.ads.googleads.v21.enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus
...
func init() { file_google_ads_googleads_v21_resources_geo_target_constant_proto_init() }
func file_google_ads_googleads_v21_resources_geo_target_constant_proto_init() {
	if File_google_ads_googleads_v21_resources_geo_target_constant_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_geo_target_constant_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDesc), len(file_google_ads_googleads_v21_resources_geo_target_constant_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_geo_target_constant_proto_goTypes,
	...
	File_google_ads_googleads_v21_resources_geo_target_constant_proto = out.File
	file_google_ads_googleads_v21_resources_geo_target_constant_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_geo_target_constant_proto_depIdxs = nil
}
