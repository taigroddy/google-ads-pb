...
const (
	ConversionAdjustmentUploadService_UploadConversionAdjustments_FullMethodName = "/google.ads.googleads.v21.services.ConversionAdjustmentUploadService/UploadConversionAdjustments"
)
...
// UnimplementedConversionAdjustmentUploadServiceServer must be embedded to have
...
func (UnimplementedConversionAdjustmentUploadServiceServer) testEmbeddedByValue() {}
...
func RegisterConversionAdjustmentUploadServiceServer(s grpc.ServiceRegistrar, srv ConversionAdjustmentUploadServiceServer) {
	// If the following call pancis, it indicates UnimplementedConversionAdjustmentUploadServiceServer was
...
var ConversionAdjustmentUploadService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v21.services.ConversionAdjustmentUploadService",
	...
	Metadata: "google/ads/googleads/v21/services/conversion_adjustment_upload_service.proto",
}
