...
type MobileDeviceConstant struct {
	...
	Type          enums.MobileDeviceTypeEnum_MobileDeviceType `protobuf:"varint,6,opt,name=type,proto3,enum=google.ads.googleads.v21.enums.MobileDeviceTypeEnum_MobileDeviceType" json:"type,omitempty"`
...
func (x *MobileDeviceConstant) Reset() {
	*x = MobileDeviceConstant{}
	mi := &file_google_ads_googleads_v21_resources_mobile_device_constant_proto_msgTypes[0]
...
func (*MobileDeviceConstant) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v21_resources_mobile_device_constant_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDesc = string([]byte{
	...
	0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4d, 0x6f, 0x62, 0x69,
...
var (
	file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDesc), len(file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_mobile_device_constant_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_resources_mobile_device_constant_proto_goTypes = []any{
	(*MobileDeviceConstant)(nil),                     // 0: google.ads.googleads.v21.resources.MobileDeviceConstant
	(enums.MobileDeviceTypeEnum_MobileDeviceType)(0), // 1: google.ads.googleads.v21.enums.MobileDeviceTypeEnum.MobileDeviceType
}
var file_google_ads_googleads_v21_resources_mobile_device_constant_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.MobileDeviceConstant.type:type_name -> google.ads.googleads.v21.enums.MobileDeviceTypeEnum.MobileDeviceType
...
func init() { file_google_ads_googleads_v21_resources_mobile_device_constant_proto_init() }
func file_google_ads_googleads_v21_resources_mobile_device_constant_proto_init() {
	if File_google_ads_googleads_v21_resources_mobile_device_constant_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_mobile_device_constant_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDesc), len(file_google_ads_googleads_v21_resources_mobile_device_constant_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_mobile_device_constant_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_mobile_device_constant_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_mobile_device_constant_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_mobile_device_constant_proto = out.File
	file_google_ads_googleads_v21_resources_mobile_device_constant_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_mobile_device_constant_proto_depIdxs = nil
}
