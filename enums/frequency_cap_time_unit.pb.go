...
func (FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_enumTypes[0].Descriptor()
}

func (FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_enumTypes[0]
}
...
func (FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *FrequencyCapTimeUnitEnum) Reset() {
	*x = FrequencyCapTimeUnitEnum{}
	mi := &file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_msgTypes[0]
...
func (*FrequencyCapTimeUnitEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDesc = string([]byte{
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x6e,
...
var (
	file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDesc), len(file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDescData
}

var file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_goTypes = []any{
	(FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit)(0), // 0: google.ads.googleads.v21.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit
	(*FrequencyCapTimeUnitEnum)(nil),                   // 1: google.ads.googleads.v21.enums.FrequencyCapTimeUnitEnum
}
var file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_init() }
func file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_init() {
	if File_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDesc), len(file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto = out.File
	file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_goTypes = nil
	file_google_ads_googleads_v21_enums_frequency_cap_time_unit_proto_depIdxs = nil
}
