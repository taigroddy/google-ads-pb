...
func (x *AssetGroup) Reset() {
	*x = AssetGroup{}
	mi := &file_google_ads_googleads_v19_resources_asset_group_proto_msgTypes[0]
...
func (*AssetGroup) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_asset_group_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v19_resources_asset_group_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_resources_asset_group_proto_rawDesc = string([]byte{
...
var (
	file_google_ads_googleads_v19_resources_asset_group_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_resources_asset_group_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_resources_asset_group_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_resources_asset_group_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_resources_asset_group_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_asset_group_proto_rawDesc), len(file_google_ads_googleads_v19_resources_asset_group_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_resources_asset_group_proto_rawDescData
}

var file_google_ads_googleads_v19_resources_asset_group_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v19_resources_asset_group_proto_goTypes = []any{
	(*AssetGroup)(nil), // 0: google.ads.googleads.v19.resources.AssetGroup
	(enums.AssetGroupStatusEnum_AssetGroupStatus)(0),                           // 1: google.ads.googleads.v19.enums.AssetGroupStatusEnum.AssetGroupStatus
	(enums.AssetGroupPrimaryStatusEnum_AssetGroupPrimaryStatus)(0),             // 2: google.ads.googleads.v19.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus
	(enums.AssetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReason)(0), // 3: google.ads.googleads.v19.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason
	(enums.AdStrengthEnum_AdStrength)(0),                                       // 4: google.ads.googleads.v19.enums.AdStrengthEnum.AdStrength
}
var file_google_ads_googleads_v19_resources_asset_group_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v19.resources.AssetGroup.status:type_name -> google.ads.googleads.v19.enums.AssetGroupStatusEnum.AssetGroupStatus
	2, // 1: google.ads.googleads.v19.resources.AssetGroup.primary_status:type_name -> google.ads.googleads.v19.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus
	3, // 2: google.ads.googleads.v19.resources.AssetGroup.primary_status_reasons:type_name -> google.ads.googleads.v19.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason
	4, // 3: google.ads.googleads.v19.resources.AssetGroup.ad_strength:type_name -> google.ads.googleads.v19.enums.AdStrengthEnum.AdStrength
...
func init() { file_google_ads_googleads_v19_resources_asset_group_proto_init() }
func file_google_ads_googleads_v19_resources_asset_group_proto_init() {
	if File_google_ads_googleads_v19_resources_asset_group_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_asset_group_proto_rawDesc), len(file_google_ads_googleads_v19_resources_asset_group_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v19_resources_asset_group_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_resources_asset_group_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_resources_asset_group_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_resources_asset_group_proto = out.File
	file_google_ads_googleads_v19_resources_asset_group_proto_goTypes = nil
	file_google_ads_googleads_v19_resources_asset_group_proto_depIdxs = nil
}
