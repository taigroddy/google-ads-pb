...
func (x *ListPaymentsAccountsRequest) Reset() {
	*x = ListPaymentsAccountsRequest{}
	mi := &file_google_ads_googleads_v21_services_payments_account_service_proto_msgTypes[0]
...
func (*ListPaymentsAccountsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_payments_account_service_proto_rawDescGZIP(), []int{0}
}
...
// [PaymentsAccountService.ListPaymentsAccounts][google.ads.googleads.v21.services.PaymentsAccountService.ListPaymentsAccounts].
...
func (x *ListPaymentsAccountsResponse) Reset() {
	*x = ListPaymentsAccountsResponse{}
	mi := &file_google_ads_googleads_v21_services_payments_account_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListPaymentsAccountsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_payments_account_service_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v21_services_payments_account_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_payments_account_service_proto_rawDesc = string([]byte{
	...
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x31, 0x12, 0x2f, 0x2f, 0x76, 0x32,
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x32, 0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1b, 0x50,
...
var (
	file_google_ads_googleads_v21_services_payments_account_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_payments_account_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_payments_account_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_payments_account_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_payments_account_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_payments_account_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_payments_account_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_payments_account_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_payments_account_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v21_services_payments_account_service_proto_goTypes = []any{
	(*ListPaymentsAccountsRequest)(nil),  // 0: google.ads.googleads.v21.services.ListPaymentsAccountsRequest
	(*ListPaymentsAccountsResponse)(nil), // 1: google.ads.googleads.v21.services.ListPaymentsAccountsResponse
	(*resources.PaymentsAccount)(nil),    // 2: google.ads.googleads.v21.resources.PaymentsAccount
}
var file_google_ads_googleads_v21_services_payments_account_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v21.services.ListPaymentsAccountsResponse.payments_accounts:type_name -> google.ads.googleads.v21.resources.PaymentsAccount
	0, // 1: google.ads.googleads.v21.services.PaymentsAccountService.ListPaymentsAccounts:input_type -> google.ads.googleads.v21.services.ListPaymentsAccountsRequest
	1, // 2: google.ads.googleads.v21.services.PaymentsAccountService.ListPaymentsAccounts:output_type -> google.ads.googleads.v21.services.ListPaymentsAccountsResponse
...
func init() { file_google_ads_googleads_v21_services_payments_account_service_proto_init() }
func file_google_ads_googleads_v21_services_payments_account_service_proto_init() {
	if File_google_ads_googleads_v21_services_payments_account_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_payments_account_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_payments_account_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_payments_account_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_services_payments_account_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_services_payments_account_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_services_payments_account_service_proto = out.File
	file_google_ads_googleads_v21_services_payments_account_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_payments_account_service_proto_depIdxs = nil
}
