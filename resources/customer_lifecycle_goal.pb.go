...
// 	protoc        v6.32.1
// source: google/ads/googleads/v21/resources/customer_lifecycle_goal.proto
...
func (x *CustomerLifecycleGoal) Reset() {
	*x = CustomerLifecycleGoal{}
	mi := &file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_msgTypes[0]
...
func (*CustomerLifecycleGoal) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDesc = string([]byte{
	...
	0x76, 0x32, 0x31, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x1a, 0x43,
...
var (
	file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDesc), len(file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_goTypes = []any{
	(*CustomerLifecycleGoal)(nil),             // 0: google.ads.googleads.v21.resources.CustomerLifecycleGoal
	(*common.LifecycleGoalValueSettings)(nil), // 1: google.ads.googleads.v21.common.LifecycleGoalValueSettings
}
var file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.CustomerLifecycleGoal.customer_acquisition_goal_value_settings:type_name -> google.ads.googleads.v21.common.LifecycleGoalValueSettings
...
func init() { file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_init() }
func file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_init() {
	if File_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDesc), len(file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto = out.File
	file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_customer_lifecycle_goal_proto_depIdxs = nil
}
