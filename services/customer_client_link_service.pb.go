...
func (x *MutateCustomerClientLinkRequest) Reset() {
	*x = MutateCustomerClientLinkRequest{}
	mi := &file_google_ads_googleads_v19_services_customer_client_link_service_proto_msgTypes[0]
...
func (*MutateCustomerClientLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerClientLinkOperation) Reset() {
	*x = CustomerClientLinkOperation{}
	mi := &file_google_ads_googleads_v19_services_customer_client_link_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerClientLinkOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerClientLinkResponse) Reset() {
	*x = MutateCustomerClientLinkResponse{}
	mi := &file_google_ads_googleads_v19_services_customer_client_link_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerClientLinkResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerClientLinkResult) Reset() {
	*x = MutateCustomerClientLinkResult{}
	mi := &file_google_ads_googleads_v19_services_customer_client_link_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerClientLinkResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v19_services_customer_client_link_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDesc = string([]byte{
...
var (
	file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDescData
}

var file_google_ads_googleads_v19_services_customer_client_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v19_services_customer_client_link_service_proto_goTypes = []any{
	(*MutateCustomerClientLinkRequest)(nil),  // 0: google.ads.googleads.v19.services.MutateCustomerClientLinkRequest
	(*CustomerClientLinkOperation)(nil),      // 1: google.ads.googleads.v19.services.CustomerClientLinkOperation
	(*MutateCustomerClientLinkResponse)(nil), // 2: google.ads.googleads.v19.services.MutateCustomerClientLinkResponse
	(*MutateCustomerClientLinkResult)(nil),   // 3: google.ads.googleads.v19.services.MutateCustomerClientLinkResult
	(*fieldmaskpb.FieldMask)(nil),            // 4: google.protobuf.FieldMask
	(*resources.CustomerClientLink)(nil),     // 5: google.ads.googleads.v19.resources.CustomerClientLink
}
var file_google_ads_googleads_v19_services_customer_client_link_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v19.services.MutateCustomerClientLinkRequest.operation:type_name -> google.ads.googleads.v19.services.CustomerClientLinkOperation
	4, // 1: google.ads.googleads.v19.services.CustomerClientLinkOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v19.services.CustomerClientLinkOperation.create:type_name -> google.ads.googleads.v19.resources.CustomerClientLink
	5, // 3: google.ads.googleads.v19.services.CustomerClientLinkOperation.update:type_name -> google.ads.googleads.v19.resources.CustomerClientLink
	3, // 4: google.ads.googleads.v19.services.MutateCustomerClientLinkResponse.result:type_name -> google.ads.googleads.v19.services.MutateCustomerClientLinkResult
	0, // 5: google.ads.googleads.v19.services.CustomerClientLinkService.MutateCustomerClientLink:input_type -> google.ads.googleads.v19.services.MutateCustomerClientLinkRequest
	2, // 6: google.ads.googleads.v19.services.CustomerClientLinkService.MutateCustomerClientLink:output_type -> google.ads.googleads.v19.services.MutateCustomerClientLinkResponse
...
func init() { file_google_ads_googleads_v19_services_customer_client_link_service_proto_init() }
func file_google_ads_googleads_v19_services_customer_client_link_service_proto_init() {
	if File_google_ads_googleads_v19_services_customer_client_link_service_proto != nil {
		return
	}
	file_google_ads_googleads_v19_services_customer_client_link_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_customer_client_link_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v19_services_customer_client_link_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_services_customer_client_link_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_services_customer_client_link_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_services_customer_client_link_service_proto = out.File
	file_google_ads_googleads_v19_services_customer_client_link_service_proto_goTypes = nil
	file_google_ads_googleads_v19_services_customer_client_link_service_proto_depIdxs = nil
}
