...
func (BatchJobErrorEnum_BatchJobError) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_errors_batch_job_error_proto_enumTypes[0].Descriptor()
}

func (BatchJobErrorEnum_BatchJobError) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_errors_batch_job_error_proto_enumTypes[0]
}
...
func (BatchJobErrorEnum_BatchJobError) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BatchJobErrorEnum) Reset() {
	*x = BatchJobErrorEnum{}
	mi := &file_google_ads_googleads_v21_errors_batch_job_error_proto_msgTypes[0]
...
func (*BatchJobErrorEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v21_errors_batch_job_error_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDesc = string([]byte{
	...
	0x31, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0xce, 0x03, 0x0a, 0x11, 0x42, 0x61, 0x74,
	0x63, 0x68, 0x4a, 0x6f, 0x62, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0xb8,
	...
	0x47, 0x45, 0x10, 0x0b, 0x12, 0x33, 0x0a, 0x2f, 0x43, 0x41, 0x4d, 0x50, 0x41, 0x49, 0x47, 0x4e,
	0x5f, 0x41, 0x4e, 0x44, 0x5f, 0x43, 0x41, 0x4d, 0x50, 0x41, 0x49, 0x47, 0x4e, 0x5f, 0x41, 0x53,
	0x53, 0x45, 0x54, 0x5f, 0x54, 0x52, 0x41, 0x4e, 0x53, 0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f,
	0x46, 0x41, 0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x0c, 0x42, 0xf2, 0x01, 0x0a, 0x23, 0x63, 0x6f,
	...
	0x73, 0x42, 0x12, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4a, 0x6f, 0x62, 0x45, 0x72, 0x72, 0x6f, 0x72,
...
var (
	file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDesc), len(file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDescData
}

var file_google_ads_googleads_v21_errors_batch_job_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_errors_batch_job_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_errors_batch_job_error_proto_goTypes = []any{
	(BatchJobErrorEnum_BatchJobError)(0), // 0: google.ads.googleads.v21.errors.BatchJobErrorEnum.BatchJobError
	(*BatchJobErrorEnum)(nil),            // 1: google.ads.googleads.v21.errors.BatchJobErrorEnum
}
var file_google_ads_googleads_v21_errors_batch_job_error_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v21_errors_batch_job_error_proto_init() }
func file_google_ads_googleads_v21_errors_batch_job_error_proto_init() {
	if File_google_ads_googleads_v21_errors_batch_job_error_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDesc), len(file_google_ads_googleads_v21_errors_batch_job_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_errors_batch_job_error_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_errors_batch_job_error_proto_depIdxs,
	...
	File_google_ads_googleads_v21_errors_batch_job_error_proto = out.File
	file_google_ads_googleads_v21_errors_batch_job_error_proto_goTypes = nil
	file_google_ads_googleads_v21_errors_batch_job_error_proto_depIdxs = nil
}
