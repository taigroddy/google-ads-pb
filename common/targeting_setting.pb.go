...
func (TargetRestrictionOperation_Operator) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_common_targeting_setting_proto_enumTypes[0].Descriptor()
}

func (TargetRestrictionOperation_Operator) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_common_targeting_setting_proto_enumTypes[0]
}
...
func (TargetRestrictionOperation_Operator) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_targeting_setting_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *TargetingSetting) Reset() {
	*x = TargetingSetting{}
	mi := &file_google_ads_googleads_v21_common_targeting_setting_proto_msgTypes[0]
...
func (*TargetingSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_targeting_setting_proto_rawDescGZIP(), []int{0}
}
...
type TargetRestriction struct {
	...
	TargetingDimension enums.TargetingDimensionEnum_TargetingDimension `protobuf:"varint,1,opt,name=targeting_dimension,json=targetingDimension,proto3,enum=google.ads.googleads.v21.enums.TargetingDimensionEnum_TargetingDimension" json:"targeting_dimension,omitempty"`
...
func (x *TargetRestriction) Reset() {
	*x = TargetRestriction{}
	mi := &file_google_ads_googleads_v21_common_targeting_setting_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TargetRestriction) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_targeting_setting_proto_rawDescGZIP(), []int{1}
}
...
type TargetRestrictionOperation struct {
	...
	Operator TargetRestrictionOperation_Operator `protobuf:"varint,1,opt,name=operator,proto3,enum=google.ads.googleads.v21.common.TargetRestrictionOperation_Operator" json:"operator,omitempty"`
...
func (x *TargetRestrictionOperation) Reset() {
	*x = TargetRestrictionOperation{}
	mi := &file_google_ads_googleads_v21_common_targeting_setting_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TargetRestrictionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_targeting_setting_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v21_common_targeting_setting_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_common_targeting_setting_proto_rawDesc = string([]byte{
	...
	0x76, 0x32, 0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x1a, 0x38, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x32, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x74, 0x61, 0x72, 0x67, 0x65,
	...
	0x32, 0x31, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x3b, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	...
	0x56, 0x32, 0x31, 0x5c, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xea, 0x02, 0x23, 0x47, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x32, 0x31, 0x3a, 0x3a, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_google_ads_googleads_v21_common_targeting_setting_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_common_targeting_setting_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_common_targeting_setting_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_common_targeting_setting_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_common_targeting_setting_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_common_targeting_setting_proto_rawDesc), len(file_google_ads_googleads_v21_common_targeting_setting_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_common_targeting_setting_proto_rawDescData
}

var file_google_ads_googleads_v21_common_targeting_setting_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_common_targeting_setting_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v21_common_targeting_setting_proto_goTypes = []any{
	(TargetRestrictionOperation_Operator)(0),             // 0: google.ads.googleads.v21.common.TargetRestrictionOperation.Operator
	(*TargetingSetting)(nil),                             // 1: google.ads.googleads.v21.common.TargetingSetting
	(*TargetRestriction)(nil),                            // 2: google.ads.googleads.v21.common.TargetRestriction
	(*TargetRestrictionOperation)(nil),                   // 3: google.ads.googleads.v21.common.TargetRestrictionOperation
	(enums.TargetingDimensionEnum_TargetingDimension)(0), // 4: google.ads.googleads.v21.enums.TargetingDimensionEnum.TargetingDimension
}
var file_google_ads_googleads_v21_common_targeting_setting_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v21.common.TargetingSetting.target_restrictions:type_name -> google.ads.googleads.v21.common.TargetRestriction
	3, // 1: google.ads.googleads.v21.common.TargetingSetting.target_restriction_operations:type_name -> google.ads.googleads.v21.common.TargetRestrictionOperation
	4, // 2: google.ads.googleads.v21.common.TargetRestriction.targeting_dimension:type_name -> google.ads.googleads.v21.enums.TargetingDimensionEnum.TargetingDimension
	0, // 3: google.ads.googleads.v21.common.TargetRestrictionOperation.operator:type_name -> google.ads.googleads.v21.common.TargetRestrictionOperation.Operator
	2, // 4: google.ads.googleads.v21.common.TargetRestrictionOperation.value:type_name -> google.ads.googleads.v21.common.TargetRestriction
...
func init() { file_google_ads_googleads_v21_common_targeting_setting_proto_init() }
func file_google_ads_googleads_v21_common_targeting_setting_proto_init() {
	if File_google_ads_googleads_v21_common_targeting_setting_proto != nil {
		return
	}
	file_google_ads_googleads_v21_common_targeting_setting_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_common_targeting_setting_proto_rawDesc), len(file_google_ads_googleads_v21_common_targeting_setting_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_common_targeting_setting_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_common_targeting_setting_proto_depIdxs,
	...
	File_google_ads_googleads_v21_common_targeting_setting_proto = out.File
	file_google_ads_googleads_v21_common_targeting_setting_proto_goTypes = nil
	file_google_ads_googleads_v21_common_targeting_setting_proto_depIdxs = nil
}
