...
func (x *MutateCustomerManagerLinkRequest) Reset() {
	*x = MutateCustomerManagerLinkRequest{}
	mi := &file_google_ads_googleads_v19_services_customer_manager_link_service_proto_msgTypes[0]
...
func (*MutateCustomerManagerLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MoveManagerLinkRequest) Reset() {
	*x = MoveManagerLinkRequest{}
	mi := &file_google_ads_googleads_v19_services_customer_manager_link_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MoveManagerLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerManagerLinkOperation) Reset() {
	*x = CustomerManagerLinkOperation{}
	mi := &file_google_ads_googleads_v19_services_customer_manager_link_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerManagerLinkOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerManagerLinkResponse) Reset() {
	*x = MutateCustomerManagerLinkResponse{}
	mi := &file_google_ads_googleads_v19_services_customer_manager_link_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerManagerLinkResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MoveManagerLinkResponse) Reset() {
	*x = MoveManagerLinkResponse{}
	mi := &file_google_ads_googleads_v19_services_customer_manager_link_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MoveManagerLinkResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *MutateCustomerManagerLinkResult) Reset() {
	*x = MutateCustomerManagerLinkResult{}
	mi := &file_google_ads_googleads_v19_services_customer_manager_link_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerManagerLinkResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescGZIP(), []int{5}
}
...
var File_google_ads_googleads_v19_services_customer_manager_link_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDesc = string([]byte{
	...
	0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x3e, 0x67, 0x6f, 0x6f, 0x67,
	...
	0xe4, 0x93, 0x02, 0x3f, 0x3a, 0x01, 0x2a, 0x22, 0x3a, 0x2f, 0x76, 0x31, 0x39, 0x2f, 0x63, 0x75,
	...
	0x31, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x4d, 0x6f, 0x76, 0x65,
	...
	0x73, 0x2f, 0x76, 0x31, 0x39, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x3b, 0x73,
	...
	0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x31, 0x39, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x73, 0xca, 0x02, 0x21, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x5c, 0x56, 0x31, 0x39, 0x5c, 0x53, 0x65, 0x72,
	...
	0x56, 0x31, 0x39, 0x3a, 0x3a, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x62, 0x06, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDescData
}

var file_google_ads_googleads_v19_services_customer_manager_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_google_ads_googleads_v19_services_customer_manager_link_service_proto_goTypes = []any{
	(*MutateCustomerManagerLinkRequest)(nil),  // 0: google.ads.googleads.v19.services.MutateCustomerManagerLinkRequest
	(*MoveManagerLinkRequest)(nil),            // 1: google.ads.googleads.v19.services.MoveManagerLinkRequest
	(*CustomerManagerLinkOperation)(nil),      // 2: google.ads.googleads.v19.services.CustomerManagerLinkOperation
	(*MutateCustomerManagerLinkResponse)(nil), // 3: google.ads.googleads.v19.services.MutateCustomerManagerLinkResponse
	(*MoveManagerLinkResponse)(nil),           // 4: google.ads.googleads.v19.services.MoveManagerLinkResponse
	(*MutateCustomerManagerLinkResult)(nil),   // 5: google.ads.googleads.v19.services.MutateCustomerManagerLinkResult
	(*fieldmaskpb.FieldMask)(nil),             // 6: google.protobuf.FieldMask
	(*resources.CustomerManagerLink)(nil),     // 7: google.ads.googleads.v19.resources.CustomerManagerLink
}
var file_google_ads_googleads_v19_services_customer_manager_link_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v19.services.MutateCustomerManagerLinkRequest.operations:type_name -> google.ads.googleads.v19.services.CustomerManagerLinkOperation
	6, // 1: google.ads.googleads.v19.services.CustomerManagerLinkOperation.update_mask:type_name -> google.protobuf.FieldMask
	7, // 2: google.ads.googleads.v19.services.CustomerManagerLinkOperation.update:type_name -> google.ads.googleads.v19.resources.CustomerManagerLink
	5, // 3: google.ads.googleads.v19.services.MutateCustomerManagerLinkResponse.results:type_name -> google.ads.googleads.v19.services.MutateCustomerManagerLinkResult
	0, // 4: google.ads.googleads.v19.services.CustomerManagerLinkService.MutateCustomerManagerLink:input_type -> google.ads.googleads.v19.services.MutateCustomerManagerLinkRequest
	1, // 5: google.ads.googleads.v19.services.CustomerManagerLinkService.MoveManagerLink:input_type -> google.ads.googleads.v19.services.MoveManagerLinkRequest
	3, // 6: google.ads.googleads.v19.services.CustomerManagerLinkService.MutateCustomerManagerLink:output_type -> google.ads.googleads.v19.services.MutateCustomerManagerLinkResponse
	4, // 7: google.ads.googleads.v19.services.CustomerManagerLinkService.MoveManagerLink:output_type -> google.ads.googleads.v19.services.MoveManagerLinkResponse
...
func init() { file_google_ads_googleads_v19_services_customer_manager_link_service_proto_init() }
func file_google_ads_googleads_v19_services_customer_manager_link_service_proto_init() {
	if File_google_ads_googleads_v19_services_customer_manager_link_service_proto != nil {
		return
	}
	file_google_ads_googleads_v19_services_customer_manager_link_service_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_customer_manager_link_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v19_services_customer_manager_link_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_services_customer_manager_link_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_services_customer_manager_link_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_services_customer_manager_link_service_proto = out.File
	file_google_ads_googleads_v19_services_customer_manager_link_service_proto_goTypes = nil
	file_google_ads_googleads_v19_services_customer_manager_link_service_proto_depIdxs = nil
}
