...
const (
	SmartCampaignSuggestService_SuggestSmartCampaignBudgetOptions_FullMethodName = "/google.ads.googleads.v21.services.SmartCampaignSuggestService/SuggestSmartCampaignBudgetOptions"
	SmartCampaignSuggestService_SuggestSmartCampaignAd_FullMethodName            = "/google.ads.googleads.v21.services.SmartCampaignSuggestService/SuggestSmartCampaignAd"
	SmartCampaignSuggestService_SuggestKeywordThemes_FullMethodName              = "/google.ads.googleads.v21.services.SmartCampaignSuggestService/SuggestKeywordThemes"
)
...
// UnimplementedSmartCampaignSuggestServiceServer must be embedded to have
...
func (UnimplementedSmartCampaignSuggestServiceServer) testEmbeddedByValue() {}
...
func RegisterSmartCampaignSuggestServiceServer(s grpc.ServiceRegistrar, srv SmartCampaignSuggestServiceServer) {
	// If the following call pancis, it indicates UnimplementedSmartCampaignSuggestServiceServer was
...
var SmartCampaignSuggestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v21.services.SmartCampaignSuggestService",
	...
	Metadata: "google/ads/googleads/v21/services/smart_campaign_suggest_service.proto",
}
