...
const (
	CustomerAssetSetService_MutateCustomerAssetSets_FullMethodName = "/google.ads.googleads.v21.services.CustomerAssetSetService/MutateCustomerAssetSets"
)
...
// UnimplementedCustomerAssetSetServiceServer must be embedded to have
...
func (UnimplementedCustomerAssetSetServiceServer) testEmbeddedByValue() {}
...
func RegisterCustomerAssetSetServiceServer(s grpc.ServiceRegistrar, srv CustomerAssetSetServiceServer) {
	// If the following call pancis, it indicates UnimplementedCustomerAssetSetServiceServer was
...
var CustomerAssetSetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v21.services.CustomerAssetSetService",
	...
	Metadata: "google/ads/googleads/v21/services/customer_asset_set_service.proto",
}
