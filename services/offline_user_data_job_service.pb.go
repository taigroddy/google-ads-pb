...
func (x *CreateOfflineUserDataJobRequest) Reset() {
	*x = CreateOfflineUserDataJobRequest{}
	mi := &file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_msgTypes[0]
...
func (*CreateOfflineUserDataJobRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateOfflineUserDataJobResponse) Reset() {
	*x = CreateOfflineUserDataJobResponse{}
	mi := &file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateOfflineUserDataJobResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *RunOfflineUserDataJobRequest) Reset() {
	*x = RunOfflineUserDataJobRequest{}
	mi := &file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RunOfflineUserDataJobRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *AddOfflineUserDataJobOperationsRequest) Reset() {
	*x = AddOfflineUserDataJobOperationsRequest{}
	mi := &file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddOfflineUserDataJobOperationsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *OfflineUserDataJobOperation) Reset() {
	*x = OfflineUserDataJobOperation{}
	mi := &file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OfflineUserDataJobOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *AddOfflineUserDataJobOperationsResponse) Reset() {
	*x = AddOfflineUserDataJobOperationsResponse{}
	mi := &file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddOfflineUserDataJobOperationsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescGZIP(), []int{5}
}
...
var File_google_ads_googleads_v19_services_offline_user_data_job_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDesc = string([]byte{
	...
	0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x37, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x31, 0x39, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x6f, 0x66, 0x66, 0x6c,
	...
	0x76, 0x31, 0x39, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4f, 0x66,
	...
	0x31, 0x39, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x39, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x55,
	...
	0x01, 0x2a, 0x22, 0x39, 0x2f, 0x76, 0x31, 0x39, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65,
	...
	0x3a, 0x01, 0x2a, 0x22, 0x3a, 0x2f, 0x76, 0x31, 0x39, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75,
...
var (
	file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDescData
}

var file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_goTypes = []any{
	(*CreateOfflineUserDataJobRequest)(nil),         // 0: google.ads.googleads.v19.services.CreateOfflineUserDataJobRequest
	(*CreateOfflineUserDataJobResponse)(nil),        // 1: google.ads.googleads.v19.services.CreateOfflineUserDataJobResponse
	(*RunOfflineUserDataJobRequest)(nil),            // 2: google.ads.googleads.v19.services.RunOfflineUserDataJobRequest
	(*AddOfflineUserDataJobOperationsRequest)(nil),  // 3: google.ads.googleads.v19.services.AddOfflineUserDataJobOperationsRequest
	(*OfflineUserDataJobOperation)(nil),             // 4: google.ads.googleads.v19.services.OfflineUserDataJobOperation
	(*AddOfflineUserDataJobOperationsResponse)(nil), // 5: google.ads.googleads.v19.services.AddOfflineUserDataJobOperationsResponse
	(*resources.OfflineUserDataJob)(nil),            // 6: google.ads.googleads.v19.resources.OfflineUserDataJob
	(*common.UserData)(nil),                         // 7: google.ads.googleads.v19.common.UserData
	(*status.Status)(nil),                           // 8: google.rpc.Status
	(*longrunningpb.Operation)(nil),                 // 9: google.longrunning.Operation
}
var file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_depIdxs = []int32{
	6, // 0: google.ads.googleads.v19.services.CreateOfflineUserDataJobRequest.job:type_name -> google.ads.googleads.v19.resources.OfflineUserDataJob
	4, // 1: google.ads.googleads.v19.services.AddOfflineUserDataJobOperationsRequest.operations:type_name -> google.ads.googleads.v19.services.OfflineUserDataJobOperation
	7, // 2: google.ads.googleads.v19.services.OfflineUserDataJobOperation.create:type_name -> google.ads.googleads.v19.common.UserData
	7, // 3: google.ads.googleads.v19.services.OfflineUserDataJobOperation.remove:type_name -> google.ads.googleads.v19.common.UserData
	8, // 4: google.ads.googleads.v19.services.AddOfflineUserDataJobOperationsResponse.partial_failure_error:type_name -> google.rpc.Status
	8, // 5: google.ads.googleads.v19.services.AddOfflineUserDataJobOperationsResponse.warning:type_name -> google.rpc.Status
	0, // 6: google.ads.googleads.v19.services.OfflineUserDataJobService.CreateOfflineUserDataJob:input_type -> google.ads.googleads.v19.services.CreateOfflineUserDataJobRequest
	3, // 7: google.ads.googleads.v19.services.OfflineUserDataJobService.AddOfflineUserDataJobOperations:input_type -> google.ads.googleads.v19.services.AddOfflineUserDataJobOperationsRequest
	2, // 8: google.ads.googleads.v19.services.OfflineUserDataJobService.RunOfflineUserDataJob:input_type -> google.ads.googleads.v19.services.RunOfflineUserDataJobRequest
	1, // 9: google.ads.googleads.v19.services.OfflineUserDataJobService.CreateOfflineUserDataJob:output_type -> google.ads.googleads.v19.services.CreateOfflineUserDataJobResponse
	5, // 10: google.ads.googleads.v19.services.OfflineUserDataJobService.AddOfflineUserDataJobOperations:output_type -> google.ads.googleads.v19.services.AddOfflineUserDataJobOperationsResponse
	9, // 11: google.ads.googleads.v19.services.OfflineUserDataJobService.RunOfflineUserDataJob:output_type -> google.longrunning.Operation
...
func init() { file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_init() }
func file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_init() {
	if File_google_ads_googleads_v19_services_offline_user_data_job_service_proto != nil {
		return
	}
	file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_msgTypes[3].OneofWrappers = []any{}
	file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_services_offline_user_data_job_service_proto = out.File
	file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_goTypes = nil
	file_google_ads_googleads_v19_services_offline_user_data_job_service_proto_depIdxs = nil
}
