...
const (
	BiddingDataExclusionService_MutateBiddingDataExclusions_FullMethodName = "/google.ads.googleads.v21.services.BiddingDataExclusionService/MutateBiddingDataExclusions"
)
...
// UnimplementedBiddingDataExclusionServiceServer must be embedded to have
...
func (UnimplementedBiddingDataExclusionServiceServer) testEmbeddedByValue() {}
...
func RegisterBiddingDataExclusionServiceServer(s grpc.ServiceRegistrar, srv BiddingDataExclusionServiceServer) {
	// If the following call pancis, it indicates UnimplementedBiddingDataExclusionServiceServer was
...
var BiddingDataExclusionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v21.services.BiddingDataExclusionService",
	...
	Metadata: "google/ads/googleads/v21/services/bidding_data_exclusion_service.proto",
}
