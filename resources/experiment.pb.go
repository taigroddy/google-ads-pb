...
type Experiment struct {
	...
	Type enums.ExperimentTypeEnum_ExperimentType `protobuf:"varint,13,opt,name=type,proto3,enum=google.ads.googleads.v21.enums.ExperimentTypeEnum_ExperimentType" json:"type,omitempty"`
	// The Advertiser-chosen status of this experiment.
	Status enums.ExperimentStatusEnum_ExperimentStatus `protobuf:"varint,14,opt,name=status,proto3,enum=google.ads.googleads.v21.enums.ExperimentStatusEnum_ExperimentStatus" json:"status,omitempty"`
	...
	PromoteStatus enums.AsyncActionStatusEnum_AsyncActionStatus `protobuf:"varint,19,opt,name=promote_status,json=promoteStatus,proto3,enum=google.ads.googleads.v21.enums.AsyncActionStatusEnum_AsyncActionStatus" json:"promote_status,omitempty"`
...
func (x *Experiment) Reset() {
	*x = Experiment{}
	mi := &file_google_ads_googleads_v21_resources_experiment_proto_msgTypes[0]
...
func (*Experiment) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_experiment_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v21_resources_experiment_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_experiment_proto_rawDesc = string([]byte{
	...
	0x76, 0x32, 0x31, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x6d, 0x65, 0x74, 0x72, 0x69,
	0x63, 0x5f, 0x67, 0x6f, 0x61, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x38, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2f, 0x76, 0x32, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x73, 0x79,
	...
	0x65, 0x61, 0x64, 0x73, 0x2f, 0x76, 0x32, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x65,
...
var (
	file_google_ads_googleads_v21_resources_experiment_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_experiment_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_experiment_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_experiment_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_experiment_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_experiment_proto_rawDesc), len(file_google_ads_googleads_v21_resources_experiment_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_experiment_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_experiment_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_resources_experiment_proto_goTypes = []any{
	(*Experiment)(nil),                                 // 0: google.ads.googleads.v21.resources.Experiment
	(enums.ExperimentTypeEnum_ExperimentType)(0),       // 1: google.ads.googleads.v21.enums.ExperimentTypeEnum.ExperimentType
	(enums.ExperimentStatusEnum_ExperimentStatus)(0),   // 2: google.ads.googleads.v21.enums.ExperimentStatusEnum.ExperimentStatus
	(*common.MetricGoal)(nil),                          // 3: google.ads.googleads.v21.common.MetricGoal
	(enums.AsyncActionStatusEnum_AsyncActionStatus)(0), // 4: google.ads.googleads.v21.enums.AsyncActionStatusEnum.AsyncActionStatus
}
var file_google_ads_googleads_v21_resources_experiment_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.Experiment.type:type_name -> google.ads.googleads.v21.enums.ExperimentTypeEnum.ExperimentType
	2, // 1: google.ads.googleads.v21.resources.Experiment.status:type_name -> google.ads.googleads.v21.enums.ExperimentStatusEnum.ExperimentStatus
	3, // 2: google.ads.googleads.v21.resources.Experiment.goals:type_name -> google.ads.googleads.v21.common.MetricGoal
	4, // 3: google.ads.googleads.v21.resources.Experiment.promote_status:type_name -> google.ads.googleads.v21.enums.AsyncActionStatusEnum.AsyncActionStatus
...
func init() { file_google_ads_googleads_v21_resources_experiment_proto_init() }
func file_google_ads_googleads_v21_resources_experiment_proto_init() {
	if File_google_ads_googleads_v21_resources_experiment_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_experiment_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_experiment_proto_rawDesc), len(file_google_ads_googleads_v21_resources_experiment_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_experiment_proto_goTypes,
	...
	File_google_ads_googleads_v21_resources_experiment_proto = out.File
	file_google_ads_googleads_v21_resources_experiment_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_experiment_proto_depIdxs = nil
}
