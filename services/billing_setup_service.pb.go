...
func (x *MutateBillingSetupRequest) Reset() {
	*x = MutateBillingSetupRequest{}
	mi := &file_google_ads_googleads_v21_services_billing_setup_service_proto_msgTypes[0]
...
func (*MutateBillingSetupRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *BillingSetupOperation) Reset() {
	*x = BillingSetupOperation{}
	mi := &file_google_ads_googleads_v21_services_billing_setup_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BillingSetupOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateBillingSetupResponse) Reset() {
	*x = MutateBillingSetupResponse{}
	mi := &file_google_ads_googleads_v21_services_billing_setup_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateBillingSetupResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateBillingSetupResult) Reset() {
	*x = MutateBillingSetupResult{}
	mi := &file_google_ads_googleads_v21_services_billing_setup_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateBillingSetupResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v21_services_billing_setup_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDesc = string([]byte{
	...
	0x93, 0x02, 0x38, 0x3a, 0x01, 0x2a, 0x22, 0x33, 0x2f, 0x76, 0x32, 0x31, 0x2f, 0x63, 0x75, 0x73,
	...
	0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e,
	0x76, 0x32, 0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x18, 0x42, 0x69,
...
var (
	file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_billing_setup_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v21_services_billing_setup_service_proto_goTypes = []any{
	(*MutateBillingSetupRequest)(nil),  // 0: google.ads.googleads.v21.services.MutateBillingSetupRequest
	(*BillingSetupOperation)(nil),      // 1: google.ads.googleads.v21.services.BillingSetupOperation
	(*MutateBillingSetupResponse)(nil), // 2: google.ads.googleads.v21.services.MutateBillingSetupResponse
	(*MutateBillingSetupResult)(nil),   // 3: google.ads.googleads.v21.services.MutateBillingSetupResult
	(*resources.BillingSetup)(nil),     // 4: google.ads.googleads.v21.resources.BillingSetup
}
var file_google_ads_googleads_v21_services_billing_setup_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.services.MutateBillingSetupRequest.operation:type_name -> google.ads.googleads.v21.services.BillingSetupOperation
	4, // 1: google.ads.googleads.v21.services.BillingSetupOperation.create:type_name -> google.ads.googleads.v21.resources.BillingSetup
	3, // 2: google.ads.googleads.v21.services.MutateBillingSetupResponse.result:type_name -> google.ads.googleads.v21.services.MutateBillingSetupResult
	0, // 3: google.ads.googleads.v21.services.BillingSetupService.MutateBillingSetup:input_type -> google.ads.googleads.v21.services.MutateBillingSetupRequest
...
func init() { file_google_ads_googleads_v21_services_billing_setup_service_proto_init() }
func file_google_ads_googleads_v21_services_billing_setup_service_proto_init() {
	if File_google_ads_googleads_v21_services_billing_setup_service_proto != nil {
		return
	}
	file_google_ads_googleads_v21_services_billing_setup_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_billing_setup_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_billing_setup_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_services_billing_setup_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_services_billing_setup_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_services_billing_setup_service_proto = out.File
	file_google_ads_googleads_v21_services_billing_setup_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_billing_setup_service_proto_depIdxs = nil
}
