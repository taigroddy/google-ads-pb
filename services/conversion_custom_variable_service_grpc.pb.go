...
const (
	ConversionCustomVariableService_MutateConversionCustomVariables_FullMethodName = "/google.ads.googleads.v21.services.ConversionCustomVariableService/MutateConversionCustomVariables"
)
...
// UnimplementedConversionCustomVariableServiceServer must be embedded to have
...
func (UnimplementedConversionCustomVariableServiceServer) testEmbeddedByValue() {}
...
func RegisterConversionCustomVariableServiceServer(s grpc.ServiceRegistrar, srv ConversionCustomVariableServiceServer) {
	// If the following call pancis, it indicates UnimplementedConversionCustomVariableServiceServer was
...
var ConversionCustomVariableService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v21.services.ConversionCustomVariableService",
	...
	Metadata: "google/ads/googleads/v21/services/conversion_custom_variable_service.proto",
}
