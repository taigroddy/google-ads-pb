...
const (
	RecommendationSubscriptionService_MutateRecommendationSubscription_FullMethodName = "/google.ads.googleads.v21.services.RecommendationSubscriptionService/MutateRecommendationSubscription"
)
...
// UnimplementedRecommendationSubscriptionServiceServer must be embedded to have
...
func (UnimplementedRecommendationSubscriptionServiceServer) testEmbeddedByValue() {}
...
func RegisterRecommendationSubscriptionServiceServer(s grpc.ServiceRegistrar, srv RecommendationSubscriptionServiceServer) {
	// If the following call pancis, it indicates UnimplementedRecommendationSubscriptionServiceServer was
...
var RecommendationSubscriptionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v21.services.RecommendationSubscriptionService",
	...
	Metadata: "google/ads/googleads/v21/services/recommendation_subscription_service.proto",
}
