...
// internalAdGroupAdLabelClient is an interface that defines the methods available from Google Ads API.
...
func (c *adGroupAdLabelGRPCClient) MutateAdGroupAdLabels(ctx context.Context, req *servicespb.MutateAdGroupAdLabelsRequest, opts ...gax.CallOption) (*servicespb.MutateAdGroupAdLabelsResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.adGroupAdLabelClient.MutateAdGroupAdLabels, req, settings.GRPC, c.logger, "MutateAdGroupAdLabels")
		return err
	}, opts...)
	if err != nil {
		return nil, err
