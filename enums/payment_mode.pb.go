...
func (PaymentModeEnum_PaymentMode) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_enums_payment_mode_proto_enumTypes[0].Descriptor()
}

func (PaymentModeEnum_PaymentMode) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_enums_payment_mode_proto_enumTypes[0]
}
...
func (PaymentModeEnum_PaymentMode) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_payment_mode_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *PaymentModeEnum) Reset() {
	*x = PaymentModeEnum{}
	mi := &file_google_ads_googleads_v21_enums_payment_mode_proto_msgTypes[0]
...
func (*PaymentModeEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_payment_mode_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v21_enums_payment_mode_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_enums_payment_mode_proto_rawDesc = string([]byte{
...
var (
	file_google_ads_googleads_v21_enums_payment_mode_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_enums_payment_mode_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_enums_payment_mode_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_enums_payment_mode_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_enums_payment_mode_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_payment_mode_proto_rawDesc), len(file_google_ads_googleads_v21_enums_payment_mode_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_enums_payment_mode_proto_rawDescData
}

var file_google_ads_googleads_v21_enums_payment_mode_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_enums_payment_mode_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_enums_payment_mode_proto_goTypes = []any{
	(PaymentModeEnum_PaymentMode)(0), // 0: google.ads.googleads.v21.enums.PaymentModeEnum.PaymentMode
	(*PaymentModeEnum)(nil),          // 1: google.ads.googleads.v21.enums.PaymentModeEnum
}
var file_google_ads_googleads_v21_enums_payment_mode_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v21_enums_payment_mode_proto_init() }
func file_google_ads_googleads_v21_enums_payment_mode_proto_init() {
	if File_google_ads_googleads_v21_enums_payment_mode_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_payment_mode_proto_rawDesc), len(file_google_ads_googleads_v21_enums_payment_mode_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_enums_payment_mode_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_enums_payment_mode_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v21_enums_payment_mode_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v21_enums_payment_mode_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_enums_payment_mode_proto = out.File
	file_google_ads_googleads_v21_enums_payment_mode_proto_goTypes = nil
	file_google_ads_googleads_v21_enums_payment_mode_proto_depIdxs = nil
}
