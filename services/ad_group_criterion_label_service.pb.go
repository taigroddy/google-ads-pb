...
func (x *MutateAdGroupCriterionLabelsRequest) Reset() {
	*x = MutateAdGroupCriterionLabelsRequest{}
	mi := &file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_msgTypes[0]
...
func (*MutateAdGroupCriterionLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupCriterionLabelOperation) Reset() {
	*x = AdGroupCriterionLabelOperation{}
	mi := &file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdGroupCriterionLabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupCriterionLabelsResponse) Reset() {
	*x = MutateAdGroupCriterionLabelsResponse{}
	mi := &file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupCriterionLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupCriterionLabelResult) Reset() {
	*x = MutateAdGroupCriterionLabelResult{}
	mi := &file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupCriterionLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDesc = string([]byte{
	...
	0x6e, 0x73, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x41, 0x3a, 0x01, 0x2a, 0x22, 0x3c, 0x2f, 0x76, 0x32,
...
var (
	file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_goTypes = []any{
	(*MutateAdGroupCriterionLabelsRequest)(nil),  // 0: google.ads.googleads.v21.services.MutateAdGroupCriterionLabelsRequest
	(*AdGroupCriterionLabelOperation)(nil),       // 1: google.ads.googleads.v21.services.AdGroupCriterionLabelOperation
	(*MutateAdGroupCriterionLabelsResponse)(nil), // 2: google.ads.googleads.v21.services.MutateAdGroupCriterionLabelsResponse
	(*MutateAdGroupCriterionLabelResult)(nil),    // 3: google.ads.googleads.v21.services.MutateAdGroupCriterionLabelResult
	(*resources.AdGroupCriterionLabel)(nil),      // 4: google.ads.googleads.v21.resources.AdGroupCriterionLabel
	(*status.Status)(nil),                        // 5: google.rpc.Status
}
var file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.services.MutateAdGroupCriterionLabelsRequest.operations:type_name -> google.ads.googleads.v21.services.AdGroupCriterionLabelOperation
	4, // 1: google.ads.googleads.v21.services.AdGroupCriterionLabelOperation.create:type_name -> google.ads.googleads.v21.resources.AdGroupCriterionLabel
	5, // 2: google.ads.googleads.v21.services.MutateAdGroupCriterionLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 3: google.ads.googleads.v21.services.MutateAdGroupCriterionLabelsResponse.results:type_name -> google.ads.googleads.v21.services.MutateAdGroupCriterionLabelResult
	0, // 4: google.ads.googleads.v21.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:input_type -> google.ads.googleads.v21.services.MutateAdGroupCriterionLabelsRequest
	2, // 5: google.ads.googleads.v21.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:output_type -> google.ads.googleads.v21.services.MutateAdGroupCriterionLabelsResponse
...
func init() { file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_init() }
func file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_init() {
	if File_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto != nil {
		return
	}
	file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto = out.File
	file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_ad_group_criterion_label_service_proto_depIdxs = nil
}
