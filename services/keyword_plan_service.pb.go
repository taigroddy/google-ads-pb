...
func (x *MutateKeywordPlansRequest) Reset() {
	*x = MutateKeywordPlansRequest{}
	mi := &file_google_ads_googleads_v21_services_keyword_plan_service_proto_msgTypes[0]
...
func (*MutateKeywordPlansRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordPlanOperation) Reset() {
	*x = KeywordPlanOperation{}
	mi := &file_google_ads_googleads_v21_services_keyword_plan_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordPlanOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateKeywordPlansResponse) Reset() {
	*x = MutateKeywordPlansResponse{}
	mi := &file_google_ads_googleads_v21_services_keyword_plan_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlansResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateKeywordPlansResult) Reset() {
	*x = MutateKeywordPlansResult{}
	mi := &file_google_ads_googleads_v21_services_keyword_plan_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlansResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v21_services_keyword_plan_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDesc = string([]byte{
	...
	0x32, 0x31, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4b, 0x65, 0x79,
...
var (
	file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_keyword_plan_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v21_services_keyword_plan_service_proto_goTypes = []any{
	(*MutateKeywordPlansRequest)(nil),  // 0: google.ads.googleads.v21.services.MutateKeywordPlansRequest
	(*KeywordPlanOperation)(nil),       // 1: google.ads.googleads.v21.services.KeywordPlanOperation
	(*MutateKeywordPlansResponse)(nil), // 2: google.ads.googleads.v21.services.MutateKeywordPlansResponse
	(*MutateKeywordPlansResult)(nil),   // 3: google.ads.googleads.v21.services.MutateKeywordPlansResult
	(*fieldmaskpb.FieldMask)(nil),      // 4: google.protobuf.FieldMask
	(*resources.KeywordPlan)(nil),      // 5: google.ads.googleads.v21.resources.KeywordPlan
	(*status.Status)(nil),              // 6: google.rpc.Status
}
var file_google_ads_googleads_v21_services_keyword_plan_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.services.MutateKeywordPlansRequest.operations:type_name -> google.ads.googleads.v21.services.KeywordPlanOperation
	4, // 1: google.ads.googleads.v21.services.KeywordPlanOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v21.services.KeywordPlanOperation.create:type_name -> google.ads.googleads.v21.resources.KeywordPlan
	5, // 3: google.ads.googleads.v21.services.KeywordPlanOperation.update:type_name -> google.ads.googleads.v21.resources.KeywordPlan
	6, // 4: google.ads.googleads.v21.services.MutateKeywordPlansResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 5: google.ads.googleads.v21.services.MutateKeywordPlansResponse.results:type_name -> google.ads.googleads.v21.services.MutateKeywordPlansResult
	0, // 6: google.ads.googleads.v21.services.KeywordPlanService.MutateKeywordPlans:input_type -> google.ads.googleads.v21.services.MutateKeywordPlansRequest
	2, // 7: google.ads.googleads.v21.services.KeywordPlanService.MutateKeywordPlans:output_type -> google.ads.googleads.v21.services.MutateKeywordPlansResponse
...
func init() { file_google_ads_googleads_v21_services_keyword_plan_service_proto_init() }
func file_google_ads_googleads_v21_services_keyword_plan_service_proto_init() {
	if File_google_ads_googleads_v21_services_keyword_plan_service_proto != nil {
		return
	}
	file_google_ads_googleads_v21_services_keyword_plan_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_keyword_plan_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_keyword_plan_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_services_keyword_plan_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_services_keyword_plan_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_services_keyword_plan_service_proto = out.File
	file_google_ads_googleads_v21_services_keyword_plan_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_keyword_plan_service_proto_depIdxs = nil
}
