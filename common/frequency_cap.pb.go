...
func (x *FrequencyCapEntry) Reset() {
	*x = FrequencyCapEntry{}
	mi := &file_google_ads_googleads_v21_common_frequency_cap_proto_msgTypes[0]
...
func (*FrequencyCapEntry) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_frequency_cap_proto_rawDescGZIP(), []int{0}
}
...
type FrequencyCapKey struct {
	...
	Level enums.FrequencyCapLevelEnum_FrequencyCapLevel `protobuf:"varint,1,opt,name=level,proto3,enum=google.ads.googleads.v21.enums.FrequencyCapLevelEnum_FrequencyCapLevel" json:"level,omitempty"`
	// The type of event that the cap applies to (for example, impression).
	EventType enums.FrequencyCapEventTypeEnum_FrequencyCapEventType `protobuf:"varint,3,opt,name=event_type,json=eventType,proto3,enum=google.ads.googleads.v21.enums.FrequencyCapEventTypeEnum_FrequencyCapEventType" json:"event_type,omitempty"`
...
func (x *FrequencyCapKey) Reset() {
	*x = FrequencyCapKey{}
	mi := &file_google_ads_googleads_v21_common_frequency_cap_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FrequencyCapKey) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_frequency_cap_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v21_common_frequency_cap_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_common_frequency_cap_proto_rawDesc = string([]byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x46, 0x72,
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x46, 0x72, 0x65,
...
var (
	file_google_ads_googleads_v21_common_frequency_cap_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_common_frequency_cap_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_common_frequency_cap_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_common_frequency_cap_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_common_frequency_cap_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_common_frequency_cap_proto_rawDesc), len(file_google_ads_googleads_v21_common_frequency_cap_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_common_frequency_cap_proto_rawDescData
}

var file_google_ads_googleads_v21_common_frequency_cap_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v21_common_frequency_cap_proto_goTypes = []any{
	(*FrequencyCapEntry)(nil),                                  // 0: google.ads.googleads.v21.common.FrequencyCapEntry
	(*FrequencyCapKey)(nil),                                    // 1: google.ads.googleads.v21.common.FrequencyCapKey
	(enums.FrequencyCapLevelEnum_FrequencyCapLevel)(0),         // 2: google.ads.googleads.v21.enums.FrequencyCapLevelEnum.FrequencyCapLevel
	(enums.FrequencyCapEventTypeEnum_FrequencyCapEventType)(0), // 3: google.ads.googleads.v21.enums.FrequencyCapEventTypeEnum.FrequencyCapEventType
	(enums.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit)(0),   // 4: google.ads.googleads.v21.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit
}
var file_google_ads_googleads_v21_common_frequency_cap_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.common.FrequencyCapEntry.key:type_name -> google.ads.googleads.v21.common.FrequencyCapKey
	2, // 1: google.ads.googleads.v21.common.FrequencyCapKey.level:type_name -> google.ads.googleads.v21.enums.FrequencyCapLevelEnum.FrequencyCapLevel
	3, // 2: google.ads.googleads.v21.common.FrequencyCapKey.event_type:type_name -> google.ads.googleads.v21.enums.FrequencyCapEventTypeEnum.FrequencyCapEventType
	4, // 3: google.ads.googleads.v21.common.FrequencyCapKey.time_unit:type_name -> google.ads.googleads.v21.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit
...
func init() { file_google_ads_googleads_v21_common_frequency_cap_proto_init() }
func file_google_ads_googleads_v21_common_frequency_cap_proto_init() {
	if File_google_ads_googleads_v21_common_frequency_cap_proto != nil {
		return
	}
	file_google_ads_googleads_v21_common_frequency_cap_proto_msgTypes[0].OneofWrappers = []any{}
	file_google_ads_googleads_v21_common_frequency_cap_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_common_frequency_cap_proto_rawDesc), len(file_google_ads_googleads_v21_common_frequency_cap_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_common_frequency_cap_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_common_frequency_cap_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_common_frequency_cap_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_common_frequency_cap_proto = out.File
	file_google_ads_googleads_v21_common_frequency_cap_proto_goTypes = nil
	file_google_ads_googleads_v21_common_frequency_cap_proto_depIdxs = nil
}
