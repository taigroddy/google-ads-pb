...
func (x *CampaignLifecycleGoal) Reset() {
	*x = CampaignLifecycleGoal{}
	mi := &file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_msgTypes[0]
...
func (*CampaignLifecycleGoal) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerAcquisitionGoalSettings) Reset() {
	*x = CustomerAcquisitionGoalSettings{}
	mi := &file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerAcquisitionGoalSettings) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDesc = string([]byte{
...
var (
	file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDesc), len(file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_goTypes = []any{
	(*CampaignLifecycleGoal)(nil),           // 0: google.ads.googleads.v21.resources.CampaignLifecycleGoal
	(*CustomerAcquisitionGoalSettings)(nil), // 1: google.ads.googleads.v21.resources.CustomerAcquisitionGoalSettings
	(enums.CustomerAcquisitionOptimizationModeEnum_CustomerAcquisitionOptimizationMode)(0), // 2: google.ads.googleads.v21.enums.CustomerAcquisitionOptimizationModeEnum.CustomerAcquisitionOptimizationMode
	(*common.LifecycleGoalValueSettings)(nil),                                              // 3: google.ads.googleads.v21.common.LifecycleGoalValueSettings
}
var file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.CampaignLifecycleGoal.customer_acquisition_goal_settings:type_name -> google.ads.googleads.v21.resources.CustomerAcquisitionGoalSettings
	2, // 1: google.ads.googleads.v21.resources.CustomerAcquisitionGoalSettings.optimization_mode:type_name -> google.ads.googleads.v21.enums.CustomerAcquisitionOptimizationModeEnum.CustomerAcquisitionOptimizationMode
	3, // 2: google.ads.googleads.v21.resources.CustomerAcquisitionGoalSettings.value_settings:type_name -> google.ads.googleads.v21.common.LifecycleGoalValueSettings
...
func init() { file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_init() }
func file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_init() {
	if File_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDesc), len(file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto = out.File
	file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_campaign_lifecycle_goal_proto_depIdxs = nil
}
