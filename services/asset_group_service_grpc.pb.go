...
const (
	AssetGroupService_MutateAssetGroups_FullMethodName = "/google.ads.googleads.v21.services.AssetGroupService/MutateAssetGroups"
)
...
// UnimplementedAssetGroupServiceServer must be embedded to have
...
func (UnimplementedAssetGroupServiceServer) testEmbeddedByValue()                           {}
...
func RegisterAssetGroupServiceServer(s grpc.ServiceRegistrar, srv AssetGroupServiceServer) {
	// If the following call pancis, it indicates UnimplementedAssetGroupServiceServer was
...
var AssetGroupService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v21.services.AssetGroupService",
	...
	Metadata: "google/ads/googleads/v21/services/asset_group_service.proto",
}
