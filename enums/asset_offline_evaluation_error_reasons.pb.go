...
func (AssetOfflineEvaluationErrorReasonsEnum_AssetOfflineEvaluationErrorReasons) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_enumTypes[0].Descriptor()
}

func (AssetOfflineEvaluationErrorReasonsEnum_AssetOfflineEvaluationErrorReasons) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_enumTypes[0]
}
...
func (AssetOfflineEvaluationErrorReasonsEnum_AssetOfflineEvaluationErrorReasons) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AssetOfflineEvaluationErrorReasonsEnum) Reset() {
	*x = AssetOfflineEvaluationErrorReasonsEnum{}
	mi := &file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_msgTypes[0]
...
func (*AssetOfflineEvaluationErrorReasonsEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDesc = string([]byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xa5, 0x03,
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x27, 0x41, 0x73,
...
var (
	file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDesc), len(file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDescData
}

var file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_goTypes = []any{
	(AssetOfflineEvaluationErrorReasonsEnum_AssetOfflineEvaluationErrorReasons)(0), // 0: google.ads.googleads.v21.enums.AssetOfflineEvaluationErrorReasonsEnum.AssetOfflineEvaluationErrorReasons
	(*AssetOfflineEvaluationErrorReasonsEnum)(nil),                                 // 1: google.ads.googleads.v21.enums.AssetOfflineEvaluationErrorReasonsEnum
}
var file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_init() }
func file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_init() {
	if File_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDesc), len(file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto = out.File
	file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_goTypes = nil
	file_google_ads_googleads_v21_enums_asset_offline_evaluation_error_reasons_proto_depIdxs = nil
}
