...
func (x *MutateAdGroupAdLabelsRequest) Reset() {
	*x = MutateAdGroupAdLabelsRequest{}
	mi := &file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_msgTypes[0]
...
func (*MutateAdGroupAdLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupAdLabelOperation) Reset() {
	*x = AdGroupAdLabelOperation{}
	mi := &file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdGroupAdLabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupAdLabelsResponse) Reset() {
	*x = MutateAdGroupAdLabelsResponse{}
	mi := &file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupAdLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupAdLabelResult) Reset() {
	*x = MutateAdGroupAdLabelResult{}
	mi := &file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupAdLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v19_services_ad_group_ad_label_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDesc = string([]byte{
	...
	0x01, 0x2a, 0x22, 0x35, 0x2f, 0x76, 0x31, 0x39, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65,
	...
	0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1a, 0x41, 0x64, 0x47, 0x72,
	0x6f, 0x75, 0x70, 0x41, 0x64, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var (
	file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDescData
}

var file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_goTypes = []any{
	(*MutateAdGroupAdLabelsRequest)(nil),  // 0: google.ads.googleads.v19.services.MutateAdGroupAdLabelsRequest
	(*AdGroupAdLabelOperation)(nil),       // 1: google.ads.googleads.v19.services.AdGroupAdLabelOperation
	(*MutateAdGroupAdLabelsResponse)(nil), // 2: google.ads.googleads.v19.services.MutateAdGroupAdLabelsResponse
	(*MutateAdGroupAdLabelResult)(nil),    // 3: google.ads.googleads.v19.services.MutateAdGroupAdLabelResult
	(*resources.AdGroupAdLabel)(nil),      // 4: google.ads.googleads.v19.resources.AdGroupAdLabel
	(*status.Status)(nil),                 // 5: google.rpc.Status
}
var file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v19.services.MutateAdGroupAdLabelsRequest.operations:type_name -> google.ads.googleads.v19.services.AdGroupAdLabelOperation
	4, // 1: google.ads.googleads.v19.services.AdGroupAdLabelOperation.create:type_name -> google.ads.googleads.v19.resources.AdGroupAdLabel
	5, // 2: google.ads.googleads.v19.services.MutateAdGroupAdLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 3: google.ads.googleads.v19.services.MutateAdGroupAdLabelsResponse.results:type_name -> google.ads.googleads.v19.services.MutateAdGroupAdLabelResult
	0, // 4: google.ads.googleads.v19.services.AdGroupAdLabelService.MutateAdGroupAdLabels:input_type -> google.ads.googleads.v19.services.MutateAdGroupAdLabelsRequest
	2, // 5: google.ads.googleads.v19.services.AdGroupAdLabelService.MutateAdGroupAdLabels:output_type -> google.ads.googleads.v19.services.MutateAdGroupAdLabelsResponse
...
func init() { file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_init() }
func file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_init() {
	if File_google_ads_googleads_v19_services_ad_group_ad_label_service_proto != nil {
		return
	}
	file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDesc), len(file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_services_ad_group_ad_label_service_proto = out.File
	file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_goTypes = nil
	file_google_ads_googleads_v19_services_ad_group_ad_label_service_proto_depIdxs = nil
}
