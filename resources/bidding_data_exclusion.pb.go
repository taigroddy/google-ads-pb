...
// 	protoc        v4.24.4
// source: google/ads/googleads/v19/resources/bidding_data_exclusion.proto
...
func (x *BiddingDataExclusion) Reset() {
	*x = BiddingDataExclusion{}
	mi := &file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_msgTypes[0]
...
func (*BiddingDataExclusion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v19_resources_bidding_data_exclusion_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDesc = string([]byte{
	...
	0x73, 0x2e, 0x76, 0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x64, 0x76, 0x65,
	...
	0x39, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x19, 0x42, 0x69, 0x64,
	0x64, 0x69, 0x6e, 0x67, 0x44, 0x61, 0x74, 0x61, 0x45, 0x78, 0x63, 0x6c, 0x75, 0x73, 0x69, 0x6f,
...
var (
	file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDesc), len(file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDescData
}

var file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_goTypes = []any{
	(*BiddingDataExclusion)(nil),                                 // 0: google.ads.googleads.v19.resources.BiddingDataExclusion
...
var file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v19.resources.BiddingDataExclusion.scope:type_name -> google.ads.googleads.v19.enums.SeasonalityEventScopeEnum.SeasonalityEventScope
	2, // 1: google.ads.googleads.v19.resources.BiddingDataExclusion.status:type_name -> google.ads.googleads.v19.enums.SeasonalityEventStatusEnum.SeasonalityEventStatus
	3, // 2: google.ads.googleads.v19.resources.BiddingDataExclusion.devices:type_name -> google.ads.googleads.v19.enums.DeviceEnum.Device
	4, // 3: google.ads.googleads.v19.resources.BiddingDataExclusion.advertising_channel_types:type_name -> google.ads.googleads.v19.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType
...
func init() { file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_init() }
func file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_init() {
	if File_google_ads_googleads_v19_resources_bidding_data_exclusion_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDesc), len(file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_resources_bidding_data_exclusion_proto = out.File
	file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_goTypes = nil
	file_google_ads_googleads_v19_resources_bidding_data_exclusion_proto_depIdxs = nil
}
