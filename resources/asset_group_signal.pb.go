...
type AssetGroupSignal struct {
	...
	ApprovalStatus enums.AssetGroupSignalApprovalStatusEnum_AssetGroupSignalApprovalStatus `protobuf:"varint,6,opt,name=approval_status,json=approvalStatus,proto3,enum=google.ads.googleads.v21.enums.AssetGroupSignalApprovalStatusEnum_AssetGroupSignalApprovalStatus" json:"approval_status,omitempty"`
...
func (x *AssetGroupSignal) Reset() {
	*x = AssetGroupSignal{}
	mi := &file_google_ads_googleads_v21_resources_asset_group_signal_proto_msgTypes[0]
...
func (*AssetGroupSignal) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v21_resources_asset_group_signal_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDesc = string([]byte{
	...
	0x2e, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x32, 0x31, 0x2e, 0x52,
	...
	0x56, 0x32, 0x31, 0x5c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0xea, 0x02, 0x26,
	0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x32, 0x31, 0x3a, 0x3a, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDesc), len(file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_asset_group_signal_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_resources_asset_group_signal_proto_goTypes = []any{
	(*AssetGroupSignal)(nil), // 0: google.ads.googleads.v21.resources.AssetGroupSignal
	(enums.AssetGroupSignalApprovalStatusEnum_AssetGroupSignalApprovalStatus)(0), // 1: google.ads.googleads.v21.enums.AssetGroupSignalApprovalStatusEnum.AssetGroupSignalApprovalStatus
	(*common.AudienceInfo)(nil),    // 2: google.ads.googleads.v21.common.AudienceInfo
	(*common.SearchThemeInfo)(nil), // 3: google.ads.googleads.v21.common.SearchThemeInfo
}
var file_google_ads_googleads_v21_resources_asset_group_signal_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.AssetGroupSignal.approval_status:type_name -> google.ads.googleads.v21.enums.AssetGroupSignalApprovalStatusEnum.AssetGroupSignalApprovalStatus
	2, // 1: google.ads.googleads.v21.resources.AssetGroupSignal.audience:type_name -> google.ads.googleads.v21.common.AudienceInfo
	3, // 2: google.ads.googleads.v21.resources.AssetGroupSignal.search_theme:type_name -> google.ads.googleads.v21.common.SearchThemeInfo
...
func init() { file_google_ads_googleads_v21_resources_asset_group_signal_proto_init() }
func file_google_ads_googleads_v21_resources_asset_group_signal_proto_init() {
	if File_google_ads_googleads_v21_resources_asset_group_signal_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_asset_group_signal_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDesc), len(file_google_ads_googleads_v21_resources_asset_group_signal_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_asset_group_signal_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_asset_group_signal_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_asset_group_signal_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_asset_group_signal_proto = out.File
	file_google_ads_googleads_v21_resources_asset_group_signal_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_asset_group_signal_proto_depIdxs = nil
}
