...
type DataLink struct {
	...
	Type enums.DataLinkTypeEnum_DataLinkType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v21.enums.DataLinkTypeEnum_DataLinkType" json:"type,omitempty"`
	// Output only. The status of the data link.
	Status enums.DataLinkStatusEnum_DataLinkStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v21.enums.DataLinkStatusEnum_DataLinkStatus" json:"status,omitempty"`
...
func (x *DataLink) Reset() {
	*x = DataLink{}
	mi := &file_google_ads_googleads_v21_resources_data_link_proto_msgTypes[0]
...
func (*DataLink) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_data_link_proto_rawDescGZIP(), []int{0}
}
...
func (x *YoutubeVideoIdentifier) Reset() {
	*x = YoutubeVideoIdentifier{}
	mi := &file_google_ads_googleads_v21_resources_data_link_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*YoutubeVideoIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_data_link_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v21_resources_data_link_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_data_link_proto_rawDesc = string([]byte{
	...
	0x32, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6c, 0x69,
	...
	0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x4c,
...
var (
	file_google_ads_googleads_v21_resources_data_link_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_data_link_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_data_link_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_data_link_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_data_link_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_data_link_proto_rawDesc), len(file_google_ads_googleads_v21_resources_data_link_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_data_link_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_data_link_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v21_resources_data_link_proto_goTypes = []any{
	(*DataLink)(nil),                             // 0: google.ads.googleads.v21.resources.DataLink
	(*YoutubeVideoIdentifier)(nil),               // 1: google.ads.googleads.v21.resources.YoutubeVideoIdentifier
	(enums.DataLinkTypeEnum_DataLinkType)(0),     // 2: google.ads.googleads.v21.enums.DataLinkTypeEnum.DataLinkType
	(enums.DataLinkStatusEnum_DataLinkStatus)(0), // 3: google.ads.googleads.v21.enums.DataLinkStatusEnum.DataLinkStatus
}
var file_google_ads_googleads_v21_resources_data_link_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v21.resources.DataLink.type:type_name -> google.ads.googleads.v21.enums.DataLinkTypeEnum.DataLinkType
	3, // 1: google.ads.googleads.v21.resources.DataLink.status:type_name -> google.ads.googleads.v21.enums.DataLinkStatusEnum.DataLinkStatus
	1, // 2: google.ads.googleads.v21.resources.DataLink.youtube_video:type_name -> google.ads.googleads.v21.resources.YoutubeVideoIdentifier
...
func init() { file_google_ads_googleads_v21_resources_data_link_proto_init() }
func file_google_ads_googleads_v21_resources_data_link_proto_init() {
	if File_google_ads_googleads_v21_resources_data_link_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_data_link_proto_msgTypes[0].OneofWrappers = []any{
		(*DataLink_YoutubeVideo)(nil),
	}
	file_google_ads_googleads_v21_resources_data_link_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_data_link_proto_rawDesc), len(file_google_ads_googleads_v21_resources_data_link_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_data_link_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_data_link_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_data_link_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_data_link_proto = out.File
	file_google_ads_googleads_v21_resources_data_link_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_data_link_proto_depIdxs = nil
}
