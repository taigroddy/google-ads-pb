...
func (x *AppendLeadConversationRequest) Reset() {
	*x = AppendLeadConversationRequest{}
	mi := &file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes[0]
...
func (*AppendLeadConversationRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AppendLeadConversationResponse) Reset() {
	*x = AppendLeadConversationResponse{}
	mi := &file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendLeadConversationResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *Conversation) Reset() {
	*x = Conversation{}
	mi := &file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Conversation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *ConversationOrError) Reset() {
	*x = ConversationOrError{}
	mi := &file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversationOrError) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescGZIP(), []int{3}
}
...
type SurveySatisfied struct {
	...
	SurveySatisfiedReason enums.LocalServicesLeadSurveySatisfiedReasonEnum_SurveySatisfiedReason `protobuf:"varint,1,opt,name=survey_satisfied_reason,json=surveySatisfiedReason,proto3,enum=google.ads.googleads.v21.enums.LocalServicesLeadSurveySatisfiedReasonEnum_SurveySatisfiedReason" json:"survey_satisfied_reason,omitempty"`
...
func (x *SurveySatisfied) Reset() {
	*x = SurveySatisfied{}
	mi := &file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SurveySatisfied) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *SurveyDissatisfied) Reset() {
	*x = SurveyDissatisfied{}
	mi := &file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SurveyDissatisfied) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescGZIP(), []int{5}
}
...
type ProvideLeadFeedbackRequest struct {
	...
	SurveyAnswer enums.LocalServicesLeadSurveyAnswerEnum_SurveyAnswer `protobuf:"varint,2,opt,name=survey_answer,json=surveyAnswer,proto3,enum=google.ads.googleads.v21.enums.LocalServicesLeadSurveyAnswerEnum_SurveyAnswer" json:"survey_answer,omitempty"`
...
func (x *ProvideLeadFeedbackRequest) Reset() {
	*x = ProvideLeadFeedbackRequest{}
	mi := &file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProvideLeadFeedbackRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescGZIP(), []int{6}
}
...
func (x *ProvideLeadFeedbackResponse) Reset() {
	*x = ProvideLeadFeedbackResponse{}
	mi := &file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProvideLeadFeedbackResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescGZIP(), []int{7}
}
...
var File_google_ads_googleads_v21_services_local_services_lead_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDesc = string([]byte{
	...
	0x32, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x5f, 0x73,
	...
	0x76, 0x32, 0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x75, 0x72,
	...
	0x32, 0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x70, 0x70, 0x65,
	...
	0x3a, 0x01, 0x2a, 0x22, 0x43, 0x2f, 0x76, 0x32, 0x31, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	...
	0x54, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x4e, 0x3a, 0x01, 0x2a, 0x22, 0x49, 0x2f, 0x76, 0x32, 0x31,
...
var (
	file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_google_ads_googleads_v21_services_local_services_lead_service_proto_goTypes = []any{
	(*AppendLeadConversationRequest)(nil),  // 0: google.ads.googleads.v21.services.AppendLeadConversationRequest
	(*AppendLeadConversationResponse)(nil), // 1: google.ads.googleads.v21.services.AppendLeadConversationResponse
	(*Conversation)(nil),                   // 2: google.ads.googleads.v21.services.Conversation
	(*ConversationOrError)(nil),            // 3: google.ads.googleads.v21.services.ConversationOrError
	(*SurveySatisfied)(nil),                // 4: google.ads.googleads.v21.services.SurveySatisfied
	(*SurveyDissatisfied)(nil),             // 5: google.ads.googleads.v21.services.SurveyDissatisfied
	(*ProvideLeadFeedbackRequest)(nil),     // 6: google.ads.googleads.v21.services.ProvideLeadFeedbackRequest
	(*ProvideLeadFeedbackResponse)(nil),    // 7: google.ads.googleads.v21.services.ProvideLeadFeedbackResponse
	(*status.Status)(nil),                  // 8: google.rpc.Status
	(enums.LocalServicesLeadSurveySatisfiedReasonEnum_SurveySatisfiedReason)(0),       // 9: google.ads.googleads.v21.enums.LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason
	(enums.LocalServicesLeadSurveyDissatisfiedReasonEnum_SurveyDissatisfiedReason)(0), // 10: google.ads.googleads.v21.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason
	(enums.LocalServicesLeadSurveyAnswerEnum_SurveyAnswer)(0),                         // 11: google.ads.googleads.v21.enums.LocalServicesLeadSurveyAnswerEnum.SurveyAnswer
	(enums.LocalServicesLeadCreditIssuanceDecisionEnum_CreditIssuanceDecision)(0),     // 12: google.ads.googleads.v21.enums.LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision
}
var file_google_ads_googleads_v21_services_local_services_lead_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v21.services.AppendLeadConversationRequest.conversations:type_name -> google.ads.googleads.v21.services.Conversation
	3,  // 1: google.ads.googleads.v21.services.AppendLeadConversationResponse.responses:type_name -> google.ads.googleads.v21.services.ConversationOrError
	8,  // 2: google.ads.googleads.v21.services.ConversationOrError.partial_failure_error:type_name -> google.rpc.Status
	9,  // 3: google.ads.googleads.v21.services.SurveySatisfied.survey_satisfied_reason:type_name -> google.ads.googleads.v21.enums.LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason
	10, // 4: google.ads.googleads.v21.services.SurveyDissatisfied.survey_dissatisfied_reason:type_name -> google.ads.googleads.v21.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason
	11, // 5: google.ads.googleads.v21.services.ProvideLeadFeedbackRequest.survey_answer:type_name -> google.ads.googleads.v21.enums.LocalServicesLeadSurveyAnswerEnum.SurveyAnswer
	4,  // 6: google.ads.googleads.v21.services.ProvideLeadFeedbackRequest.survey_satisfied:type_name -> google.ads.googleads.v21.services.SurveySatisfied
	5,  // 7: google.ads.googleads.v21.services.ProvideLeadFeedbackRequest.survey_dissatisfied:type_name -> google.ads.googleads.v21.services.SurveyDissatisfied
	12, // 8: google.ads.googleads.v21.services.ProvideLeadFeedbackResponse.credit_issuance_decision:type_name -> google.ads.googleads.v21.enums.LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision
	0,  // 9: google.ads.googleads.v21.services.LocalServicesLeadService.AppendLeadConversation:input_type -> google.ads.googleads.v21.services.AppendLeadConversationRequest
	6,  // 10: google.ads.googleads.v21.services.LocalServicesLeadService.ProvideLeadFeedback:input_type -> google.ads.googleads.v21.services.ProvideLeadFeedbackRequest
	1,  // 11: google.ads.googleads.v21.services.LocalServicesLeadService.AppendLeadConversation:output_type -> google.ads.googleads.v21.services.AppendLeadConversationResponse
	7,  // 12: google.ads.googleads.v21.services.LocalServicesLeadService.ProvideLeadFeedback:output_type -> google.ads.googleads.v21.services.ProvideLeadFeedbackResponse
...
func init() { file_google_ads_googleads_v21_services_local_services_lead_service_proto_init() }
func file_google_ads_googleads_v21_services_local_services_lead_service_proto_init() {
	if File_google_ads_googleads_v21_services_local_services_lead_service_proto != nil {
		return
	}
	file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes[3].OneofWrappers = []any{
		(*ConversationOrError_LocalServicesLeadConversation)(nil),
		(*ConversationOrError_PartialFailureError)(nil),
	}
	file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes[6].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_local_services_lead_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_local_services_lead_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_services_local_services_lead_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_services_local_services_lead_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_services_local_services_lead_service_proto = out.File
	file_google_ads_googleads_v21_services_local_services_lead_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_local_services_lead_service_proto_depIdxs = nil
}
