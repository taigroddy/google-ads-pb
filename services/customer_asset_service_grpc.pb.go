...
const (
	CustomerAssetService_MutateCustomerAssets_FullMethodName = "/google.ads.googleads.v21.services.CustomerAssetService/MutateCustomerAssets"
)
...
// UnimplementedCustomerAssetServiceServer must be embedded to have
...
func (UnimplementedCustomerAssetServiceServer) testEmbeddedByValue()                              {}
...
func RegisterCustomerAssetServiceServer(s grpc.ServiceRegistrar, srv CustomerAssetServiceServer) {
	// If the following call pancis, it indicates UnimplementedCustomerAssetServiceServer was
...
var CustomerAssetService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v21/services/customer_asset_service.proto",
}
