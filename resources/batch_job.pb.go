...
type BatchJob struct {
	...
	Status enums.BatchJobStatusEnum_BatchJobStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v21.enums.BatchJobStatusEnum_BatchJobStatus" json:"status,omitempty"`
...
func (x *BatchJob) Reset() {
	*x = BatchJob{}
	mi := &file_google_ads_googleads_v21_resources_batch_job_proto_msgTypes[0]
...
func (*BatchJob) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_batch_job_proto_rawDescGZIP(), []int{0}
}
...
func (x *BatchJob_BatchJobMetadata) Reset() {
	*x = BatchJob_BatchJobMetadata{}
	mi := &file_google_ads_googleads_v21_resources_batch_job_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BatchJob_BatchJobMetadata) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_batch_job_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_google_ads_googleads_v21_resources_batch_job_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_batch_job_proto_rawDesc = string([]byte{
	...
	0x32, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x6a,
...
var (
	file_google_ads_googleads_v21_resources_batch_job_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_batch_job_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_batch_job_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_batch_job_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_batch_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_batch_job_proto_rawDesc), len(file_google_ads_googleads_v21_resources_batch_job_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_batch_job_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_batch_job_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v21_resources_batch_job_proto_goTypes = []any{
	(*BatchJob)(nil),                             // 0: google.ads.googleads.v21.resources.BatchJob
	(*BatchJob_BatchJobMetadata)(nil),            // 1: google.ads.googleads.v21.resources.BatchJob.BatchJobMetadata
	(enums.BatchJobStatusEnum_BatchJobStatus)(0), // 2: google.ads.googleads.v21.enums.BatchJobStatusEnum.BatchJobStatus
}
var file_google_ads_googleads_v21_resources_batch_job_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.BatchJob.metadata:type_name -> google.ads.googleads.v21.resources.BatchJob.BatchJobMetadata
	2, // 1: google.ads.googleads.v21.resources.BatchJob.status:type_name -> google.ads.googleads.v21.enums.BatchJobStatusEnum.BatchJobStatus
...
func init() { file_google_ads_googleads_v21_resources_batch_job_proto_init() }
func file_google_ads_googleads_v21_resources_batch_job_proto_init() {
	if File_google_ads_googleads_v21_resources_batch_job_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_batch_job_proto_msgTypes[0].OneofWrappers = []any{}
	file_google_ads_googleads_v21_resources_batch_job_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_batch_job_proto_rawDesc), len(file_google_ads_googleads_v21_resources_batch_job_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_batch_job_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_batch_job_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_batch_job_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_batch_job_proto = out.File
	file_google_ads_googleads_v21_resources_batch_job_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_batch_job_proto_depIdxs = nil
}
