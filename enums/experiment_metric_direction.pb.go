...
func (ExperimentMetricDirectionEnum_ExperimentMetricDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_enumTypes[0].Descriptor()
}

func (ExperimentMetricDirectionEnum_ExperimentMetricDirection) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_enumTypes[0]
}
...
func (ExperimentMetricDirectionEnum_ExperimentMetricDirection) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ExperimentMetricDirectionEnum) Reset() {
	*x = ExperimentMetricDirectionEnum{}
	mi := &file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_msgTypes[0]
...
func (*ExperimentMetricDirectionEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v21_enums_experiment_metric_direction_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDesc = string([]byte{
	...
	0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1e, 0x45, 0x78, 0x70, 0x65, 0x72, 0x69,
...
var (
	file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDesc), len(file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDescData
}

var file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_goTypes = []any{
	(ExperimentMetricDirectionEnum_ExperimentMetricDirection)(0), // 0: google.ads.googleads.v21.enums.ExperimentMetricDirectionEnum.ExperimentMetricDirection
	(*ExperimentMetricDirectionEnum)(nil),                        // 1: google.ads.googleads.v21.enums.ExperimentMetricDirectionEnum
}
var file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_init() }
func file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_init() {
	if File_google_ads_googleads_v21_enums_experiment_metric_direction_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDesc), len(file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_depIdxs,
	...
	File_google_ads_googleads_v21_enums_experiment_metric_direction_proto = out.File
	file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_goTypes = nil
	file_google_ads_googleads_v21_enums_experiment_metric_direction_proto_depIdxs = nil
}
