...
type SharedSet struct {
	...
	Type enums.SharedSetTypeEnum_SharedSetType `protobuf:"varint,3,opt,name=type,proto3,enum=google.ads.googleads.v21.enums.SharedSetTypeEnum_SharedSetType" json:"type,omitempty"`
	...
	Status enums.SharedSetStatusEnum_SharedSetStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v21.enums.SharedSetStatusEnum_SharedSetStatus" json:"status,omitempty"`
...
func (x *SharedSet) Reset() {
	*x = SharedSet{}
	mi := &file_google_ads_googleads_v21_resources_shared_set_proto_msgTypes[0]
...
func (*SharedSet) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_shared_set_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v21_resources_shared_set_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_shared_set_proto_rawDesc = string([]byte{
	...
	0x76, 0x32, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64,
	...
	0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x68, 0x61, 0x72,
	...
	0x2e, 0x76, 0x32, 0x31, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x0e,
...
var (
	file_google_ads_googleads_v21_resources_shared_set_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_shared_set_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_shared_set_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_shared_set_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_shared_set_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_shared_set_proto_rawDesc), len(file_google_ads_googleads_v21_resources_shared_set_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_shared_set_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_shared_set_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_resources_shared_set_proto_goTypes = []any{
	(*SharedSet)(nil),                              // 0: google.ads.googleads.v21.resources.SharedSet
	(enums.SharedSetTypeEnum_SharedSetType)(0),     // 1: google.ads.googleads.v21.enums.SharedSetTypeEnum.SharedSetType
	(enums.SharedSetStatusEnum_SharedSetStatus)(0), // 2: google.ads.googleads.v21.enums.SharedSetStatusEnum.SharedSetStatus
}
var file_google_ads_googleads_v21_resources_shared_set_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.SharedSet.type:type_name -> google.ads.googleads.v21.enums.SharedSetTypeEnum.SharedSetType
	2, // 1: google.ads.googleads.v21.resources.SharedSet.status:type_name -> google.ads.googleads.v21.enums.SharedSetStatusEnum.SharedSetStatus
...
func init() { file_google_ads_googleads_v21_resources_shared_set_proto_init() }
func file_google_ads_googleads_v21_resources_shared_set_proto_init() {
	if File_google_ads_googleads_v21_resources_shared_set_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_shared_set_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_shared_set_proto_rawDesc), len(file_google_ads_googleads_v21_resources_shared_set_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_shared_set_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_shared_set_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_shared_set_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_shared_set_proto = out.File
	file_google_ads_googleads_v21_resources_shared_set_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_shared_set_proto_depIdxs = nil
}
