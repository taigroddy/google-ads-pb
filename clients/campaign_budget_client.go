...
// internalCampaignBudgetClient is an interface that defines the methods available from Google Ads API.
...
func (c *campaignBudgetGRPCClient) MutateCampaignBudgets(ctx context.Context, req *servicespb.MutateCampaignBudgetsRequest, opts ...gax.CallOption) (*servicespb.MutateCampaignBudgetsResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.campaignBudgetClient.MutateCampaignBudgets, req, settings.GRPC, c.logger, "MutateCampaignBudgets")
		return err
	}, opts...)
	if err != nil {
		return nil, err
