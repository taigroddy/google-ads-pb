...
type CampaignBudget struct {
	...
	Status enums.BudgetStatusEnum_BudgetStatus `protobuf:"varint,6,opt,name=status,proto3,enum=google.ads.googleads.v21.enums.BudgetStatusEnum_BudgetStatus" json:"status,omitempty"`
	// The delivery method that determines the rate at which the campaign budget
	// is spent.
	//
	// Defaults to STANDARD if unspecified in a create operation.
	DeliveryMethod enums.BudgetDeliveryMethodEnum_BudgetDeliveryMethod `protobuf:"varint,7,opt,name=delivery_method,json=deliveryMethod,proto3,enum=google.ads.googleads.v21.enums.BudgetDeliveryMethodEnum_BudgetDeliveryMethod" json:"delivery_method,omitempty"`
	...
	// specified.
	Period enums.BudgetPeriodEnum_BudgetPeriod `protobuf:"varint,13,opt,name=period,proto3,enum=google.ads.googleads.v21.enums.BudgetPeriodEnum_BudgetPeriod" json:"period,omitempty"`
	...
	Type enums.BudgetTypeEnum_BudgetType `protobuf:"varint,18,opt,name=type,proto3,enum=google.ads.googleads.v21.enums.BudgetTypeEnum_BudgetType" json:"type,omitempty"`
...
func (x *CampaignBudget) Reset() {
	*x = CampaignBudget{}
	mi := &file_google_ads_googleads_v21_resources_campaign_budget_proto_msgTypes[0]
...
func (*CampaignBudget) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v21_resources_campaign_budget_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDesc = string([]byte{
	...
	0x2e, 0x76, 0x32, 0x31, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x3b,
	...
	0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x42, 0x75, 0x64, 0x67, 0x65, 0x74,
...
var (
	file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDesc), len(file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_campaign_budget_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_resources_campaign_budget_proto_goTypes = []any{
	(*CampaignBudget)(nil),                                   // 0: google.ads.googleads.v21.resources.CampaignBudget
	(enums.BudgetStatusEnum_BudgetStatus)(0),                 // 1: google.ads.googleads.v21.enums.BudgetStatusEnum.BudgetStatus
	(enums.BudgetDeliveryMethodEnum_BudgetDeliveryMethod)(0), // 2: google.ads.googleads.v21.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod
	(enums.BudgetPeriodEnum_BudgetPeriod)(0),                 // 3: google.ads.googleads.v21.enums.BudgetPeriodEnum.BudgetPeriod
	(enums.BudgetTypeEnum_BudgetType)(0),                     // 4: google.ads.googleads.v21.enums.BudgetTypeEnum.BudgetType
}
var file_google_ads_googleads_v21_resources_campaign_budget_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.CampaignBudget.status:type_name -> google.ads.googleads.v21.enums.BudgetStatusEnum.BudgetStatus
	2, // 1: google.ads.googleads.v21.resources.CampaignBudget.delivery_method:type_name -> google.ads.googleads.v21.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod
	3, // 2: google.ads.googleads.v21.resources.CampaignBudget.period:type_name -> google.ads.googleads.v21.enums.BudgetPeriodEnum.BudgetPeriod
	4, // 3: google.ads.googleads.v21.resources.CampaignBudget.type:type_name -> google.ads.googleads.v21.enums.BudgetTypeEnum.BudgetType
...
func init() { file_google_ads_googleads_v21_resources_campaign_budget_proto_init() }
func file_google_ads_googleads_v21_resources_campaign_budget_proto_init() {
	if File_google_ads_googleads_v21_resources_campaign_budget_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_campaign_budget_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDesc), len(file_google_ads_googleads_v21_resources_campaign_budget_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_campaign_budget_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_campaign_budget_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_campaign_budget_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_campaign_budget_proto = out.File
	file_google_ads_googleads_v21_resources_campaign_budget_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_campaign_budget_proto_depIdxs = nil
}
