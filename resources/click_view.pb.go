...
func (x *ClickView) Reset() {
	*x = ClickView{}
	mi := &file_google_ads_googleads_v21_resources_click_view_proto_msgTypes[0]
...
func (*ClickView) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_click_view_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v21_resources_click_view_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_click_view_proto_rawDesc = string([]byte{
	...
	0x76, 0x32, 0x31, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x63, 0x6c, 0x69, 0x63, 0x6b,
	...
	0x32, 0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x6c, 0x69, 0x63, 0x6b, 0x4c,
...
var (
	file_google_ads_googleads_v21_resources_click_view_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_click_view_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_click_view_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_click_view_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_click_view_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_click_view_proto_rawDesc), len(file_google_ads_googleads_v21_resources_click_view_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_click_view_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_click_view_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_resources_click_view_proto_goTypes = []any{
	(*ClickView)(nil),            // 0: google.ads.googleads.v21.resources.ClickView
	(*common.ClickLocation)(nil), // 1: google.ads.googleads.v21.common.ClickLocation
	(*common.KeywordInfo)(nil),   // 2: google.ads.googleads.v21.common.KeywordInfo
}
var file_google_ads_googleads_v21_resources_click_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.ClickView.area_of_interest:type_name -> google.ads.googleads.v21.common.ClickLocation
	1, // 1: google.ads.googleads.v21.resources.ClickView.location_of_presence:type_name -> google.ads.googleads.v21.common.ClickLocation
	2, // 2: google.ads.googleads.v21.resources.ClickView.keyword_info:type_name -> google.ads.googleads.v21.common.KeywordInfo
...
func init() { file_google_ads_googleads_v21_resources_click_view_proto_init() }
func file_google_ads_googleads_v21_resources_click_view_proto_init() {
	if File_google_ads_googleads_v21_resources_click_view_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_click_view_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_click_view_proto_rawDesc), len(file_google_ads_googleads_v21_resources_click_view_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_click_view_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_click_view_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_click_view_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_click_view_proto = out.File
	file_google_ads_googleads_v21_resources_click_view_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_click_view_proto_depIdxs = nil
}
