...
const (
	CampaignBudgetService_MutateCampaignBudgets_FullMethodName = "/google.ads.googleads.v21.services.CampaignBudgetService/MutateCampaignBudgets"
)
...
// UnimplementedCampaignBudgetServiceServer must be embedded to have
...
func (UnimplementedCampaignBudgetServiceServer) testEmbeddedByValue()                               {}
...
func RegisterCampaignBudgetServiceServer(s grpc.ServiceRegistrar, srv CampaignBudgetServiceServer) {
	// If the following call pancis, it indicates UnimplementedCampaignBudgetServiceServer was
...
var CampaignBudgetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v21.services.CampaignBudgetService",
	...
	Metadata: "google/ads/googleads/v21/services/campaign_budget_service.proto",
}
