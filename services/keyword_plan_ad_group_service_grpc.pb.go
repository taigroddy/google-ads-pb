...
const (
	KeywordPlanAdGroupService_MutateKeywordPlanAdGroups_FullMethodName = "/google.ads.googleads.v21.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups"
)
...
// UnimplementedKeywordPlanAdGroupServiceServer must be embedded to have
...
func (UnimplementedKeywordPlanAdGroupServiceServer) testEmbeddedByValue() {}
...
func RegisterKeywordPlanAdGroupServiceServer(s grpc.ServiceRegistrar, srv KeywordPlanAdGroupServiceServer) {
	// If the following call pancis, it indicates UnimplementedKeywordPlanAdGroupServiceServer was
...
var KeywordPlanAdGroupService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v21.services.KeywordPlanAdGroupService",
	...
	Metadata: "google/ads/googleads/v21/services/keyword_plan_ad_group_service.proto",
}
