...
type UserInterest struct {
	...
	TaxonomyType enums.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType `protobuf:"varint,2,opt,name=taxonomy_type,json=taxonomyType,proto3,enum=google.ads.googleads.v21.enums.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType" json:"taxonomy_type,omitempty"`
...
func (x *UserInterest) Reset() {
	*x = UserInterest{}
	mi := &file_google_ads_googleads_v21_resources_user_interest_proto_msgTypes[0]
...
func (*UserInterest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_resources_user_interest_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v21_resources_user_interest_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_resources_user_interest_proto_rawDesc = string([]byte{
	...
	0x32, 0x31, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x45, 0x67, 0x6f,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x55,
	...
	0x2e, 0x76, 0x32, 0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x72, 0x69, 0x74,
...
var (
	file_google_ads_googleads_v21_resources_user_interest_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_resources_user_interest_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_resources_user_interest_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_resources_user_interest_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_resources_user_interest_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_user_interest_proto_rawDesc), len(file_google_ads_googleads_v21_resources_user_interest_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_resources_user_interest_proto_rawDescData
}

var file_google_ads_googleads_v21_resources_user_interest_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_resources_user_interest_proto_goTypes = []any{
	(*UserInterest)(nil), // 0: google.ads.googleads.v21.resources.UserInterest
	(enums.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType)(0), // 1: google.ads.googleads.v21.enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType
	(*common.CriterionCategoryAvailability)(nil),                     // 2: google.ads.googleads.v21.common.CriterionCategoryAvailability
}
var file_google_ads_googleads_v21_resources_user_interest_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.resources.UserInterest.taxonomy_type:type_name -> google.ads.googleads.v21.enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType
	2, // 1: google.ads.googleads.v21.resources.UserInterest.availabilities:type_name -> google.ads.googleads.v21.common.CriterionCategoryAvailability
...
func init() { file_google_ads_googleads_v21_resources_user_interest_proto_init() }
func file_google_ads_googleads_v21_resources_user_interest_proto_init() {
	if File_google_ads_googleads_v21_resources_user_interest_proto != nil {
		return
	}
	file_google_ads_googleads_v21_resources_user_interest_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_resources_user_interest_proto_rawDesc), len(file_google_ads_googleads_v21_resources_user_interest_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_resources_user_interest_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_resources_user_interest_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_resources_user_interest_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_resources_user_interest_proto = out.File
	file_google_ads_googleads_v21_resources_user_interest_proto_goTypes = nil
	file_google_ads_googleads_v21_resources_user_interest_proto_depIdxs = nil
}
