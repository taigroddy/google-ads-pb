...
// Request message for
// [ThirdPartyAppAnalyticsLinkService.RegenerateShareableLinkId][google.ads.googleads.v21.services.ThirdPartyAppAnalyticsLinkService.RegenerateShareableLinkId].
...
func (x *RegenerateShareableLinkIdRequest) Reset() {
	*x = RegenerateShareableLinkIdRequest{}
	mi := &file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_msgTypes[0]
...
func (*RegenerateShareableLinkIdRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *RegenerateShareableLinkIdResponse) Reset() {
	*x = RegenerateShareableLinkIdResponse{}
	mi := &file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegenerateShareableLinkIdResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDescGZIP(), []int{1}
}

var File_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDesc = string([]byte{
	...
	0x32, 0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x67, 0x65,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x5d, 0x3a, 0x01, 0x2a, 0x22, 0x58, 0x2f, 0x76, 0x32, 0x31, 0x2f, 0x7b,
...
var (
	file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_goTypes = []any{
	(*RegenerateShareableLinkIdRequest)(nil),  // 0: google.ads.googleads.v21.services.RegenerateShareableLinkIdRequest
	(*RegenerateShareableLinkIdResponse)(nil), // 1: google.ads.googleads.v21.services.RegenerateShareableLinkIdResponse
}
var file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v21.services.ThirdPartyAppAnalyticsLinkService.RegenerateShareableLinkId:input_type -> google.ads.googleads.v21.services.RegenerateShareableLinkIdRequest
	1, // 1: google.ads.googleads.v21.services.ThirdPartyAppAnalyticsLinkService.RegenerateShareableLinkId:output_type -> google.ads.googleads.v21.services.RegenerateShareableLinkIdResponse
...
func init() {
	file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_init()
}
func file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_init() {
	if File_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto = out.File
	file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_third_party_app_analytics_link_service_proto_depIdxs = nil
}
