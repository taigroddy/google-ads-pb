...
const (
	...
	AdGroupErrorEnum_INVALID_STEP_ID_FOR_VIDEO_ADS_SEQUENCING AdGroupErrorEnum_AdGroupError = 20
	// For video ads sequencing, AdGroup type has to use a type defined in
	// `campaign.video_campaign_settings.video_ad_sequence`.
	AdGroupErrorEnum_INVALID_AD_GROUP_TYPE_FOR_VIDEO_ADS_SEQUENCING AdGroupErrorEnum_AdGroupError = 21
	// Only one AdGroup is allowed for each step ID in video ads sequencing.
	AdGroupErrorEnum_DUPLICATE_STEP_ID AdGroupErrorEnum_AdGroupError = 22
)
...
var (
	AdGroupErrorEnum_AdGroupError_name = map[int32]string{
		...
		19: "INVALID_STATUS",
		20: "INVALID_STEP_ID_FOR_VIDEO_ADS_SEQUENCING",
		21: "INVALID_AD_GROUP_TYPE_FOR_VIDEO_ADS_SEQUENCING",
		22: "DUPLICATE_STEP_ID",
	}
...
func (AdGroupErrorEnum_AdGroupError) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_errors_ad_group_error_proto_enumTypes[0].Descriptor()
}

func (AdGroupErrorEnum_AdGroupError) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_errors_ad_group_error_proto_enumTypes[0]
}
...
func (AdGroupErrorEnum_AdGroupError) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AdGroupErrorEnum) Reset() {
	*x = AdGroupErrorEnum{}
	mi := &file_google_ads_googleads_v21_errors_ad_group_error_proto_msgTypes[0]
...
func (*AdGroupErrorEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v21_errors_ad_group_error_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDesc = string([]byte{
	...
	0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0xeb, 0x06, 0x0a, 0x10, 0x41, 0x64, 0x47, 0x72,
	0x6f, 0x75, 0x70, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0xd6, 0x06, 0x0a,
	...
	,
...
var (
	file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDesc), len(file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDescData
}

var file_google_ads_googleads_v21_errors_ad_group_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_errors_ad_group_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_errors_ad_group_error_proto_goTypes = []any{
	(AdGroupErrorEnum_AdGroupError)(0), // 0: google.ads.googleads.v21.errors.AdGroupErrorEnum.AdGroupError
	(*AdGroupErrorEnum)(nil),           // 1: google.ads.googleads.v21.errors.AdGroupErrorEnum
}
var file_google_ads_googleads_v21_errors_ad_group_error_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v21_errors_ad_group_error_proto_init() }
func file_google_ads_googleads_v21_errors_ad_group_error_proto_init() {
	if File_google_ads_googleads_v21_errors_ad_group_error_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDesc), len(file_google_ads_googleads_v21_errors_ad_group_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_errors_ad_group_error_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_errors_ad_group_error_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v21_errors_ad_group_error_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v21_errors_ad_group_error_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_errors_ad_group_error_proto = out.File
	file_google_ads_googleads_v21_errors_ad_group_error_proto_goTypes = nil
	file_google_ads_googleads_v21_errors_ad_group_error_proto_depIdxs = nil
}
