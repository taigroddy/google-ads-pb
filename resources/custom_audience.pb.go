...
type CustomAudience struct {
	...
	Status enums.CustomAudienceStatusEnum_CustomAudienceStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v19.enums.CustomAudienceStatusEnum_CustomAudienceStatus" json:"status,omitempty"`
	...
	Type enums.CustomAudienceTypeEnum_CustomAudienceType `protobuf:"varint,5,opt,name=type,proto3,enum=google.ads.googleads.v19.enums.CustomAudienceTypeEnum_CustomAudienceType" json:"type,omitempty"`
...
func (x *CustomAudience) Reset() {
	*x = CustomAudience{}
	mi := &file_google_ads_googleads_v19_resources_custom_audience_proto_msgTypes[0]
...
func (*CustomAudience) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_custom_audience_proto_rawDescGZIP(), []int{0}
}
...
type CustomAudienceMember struct {
	...
	MemberType enums.CustomAudienceMemberTypeEnum_CustomAudienceMemberType `protobuf:"varint,1,opt,name=member_type,json=memberType,proto3,enum=google.ads.googleads.v19.enums.CustomAudienceMemberTypeEnum_CustomAudienceMemberType" json:"member_type,omitempty"`
...
func (x *CustomAudienceMember) Reset() {
	*x = CustomAudienceMember{}
	mi := &file_google_ads_googleads_v19_resources_custom_audience_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomAudienceMember) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_custom_audience_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomAudienceMember) GetValue() isCustomAudienceMember_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *CustomAudienceMember) GetKeyword() string {
	if x != nil {
		if x, ok := x.Value.(*CustomAudienceMember_Keyword); ok {
			return x.Keyword
		}
	}
	return ""
...
func (x *CustomAudienceMember) GetUrl() string {
	if x != nil {
		if x, ok := x.Value.(*CustomAudienceMember_Url); ok {
			return x.Url
		}
	}
	return ""
...
func (x *CustomAudienceMember) GetPlaceCategory() int64 {
	if x != nil {
		if x, ok := x.Value.(*CustomAudienceMember_PlaceCategory); ok {
...
func (x *CustomAudienceMember) GetApp() string {
	if x != nil {
		if x, ok := x.Value.(*CustomAudienceMember_App); ok {
			return x.App
		}
	}
	return ""
...
var File_google_ads_googleads_v19_resources_custom_audience_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_resources_custom_audience_proto_rawDesc = string([]byte{
	...
	0x2e, 0x76, 0x31, 0x39, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x40,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x61, 0x64, 0x73, 0x2f, 0x76, 0x31, 0x39, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63,
...
var (
	file_google_ads_googleads_v19_resources_custom_audience_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_resources_custom_audience_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_resources_custom_audience_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_resources_custom_audience_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_resources_custom_audience_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_custom_audience_proto_rawDesc), len(file_google_ads_googleads_v19_resources_custom_audience_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_resources_custom_audience_proto_rawDescData
}

var file_google_ads_googleads_v19_resources_custom_audience_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v19_resources_custom_audience_proto_goTypes = []any{
	(*CustomAudience)(nil),                                           // 0: google.ads.googleads.v19.resources.CustomAudience
	(*CustomAudienceMember)(nil),                                     // 1: google.ads.googleads.v19.resources.CustomAudienceMember
	(enums.CustomAudienceStatusEnum_CustomAudienceStatus)(0),         // 2: google.ads.googleads.v19.enums.CustomAudienceStatusEnum.CustomAudienceStatus
	(enums.CustomAudienceTypeEnum_CustomAudienceType)(0),             // 3: google.ads.googleads.v19.enums.CustomAudienceTypeEnum.CustomAudienceType
	(enums.CustomAudienceMemberTypeEnum_CustomAudienceMemberType)(0), // 4: google.ads.googleads.v19.enums.CustomAudienceMemberTypeEnum.CustomAudienceMemberType
}
var file_google_ads_googleads_v19_resources_custom_audience_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v19.resources.CustomAudience.status:type_name -> google.ads.googleads.v19.enums.CustomAudienceStatusEnum.CustomAudienceStatus
	3, // 1: google.ads.googleads.v19.resources.CustomAudience.type:type_name -> google.ads.googleads.v19.enums.CustomAudienceTypeEnum.CustomAudienceType
	1, // 2: google.ads.googleads.v19.resources.CustomAudience.members:type_name -> google.ads.googleads.v19.resources.CustomAudienceMember
	4, // 3: google.ads.googleads.v19.resources.CustomAudienceMember.member_type:type_name -> google.ads.googleads.v19.enums.CustomAudienceMemberTypeEnum.CustomAudienceMemberType
...
func init() { file_google_ads_googleads_v19_resources_custom_audience_proto_init() }
func file_google_ads_googleads_v19_resources_custom_audience_proto_init() {
	if File_google_ads_googleads_v19_resources_custom_audience_proto != nil {
		return
	}
	file_google_ads_googleads_v19_resources_custom_audience_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_custom_audience_proto_rawDesc), len(file_google_ads_googleads_v19_resources_custom_audience_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v19_resources_custom_audience_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_resources_custom_audience_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_resources_custom_audience_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_resources_custom_audience_proto = out.File
	file_google_ads_googleads_v19_resources_custom_audience_proto_goTypes = nil
	file_google_ads_googleads_v19_resources_custom_audience_proto_depIdxs = nil
}
