...
type CallView struct {
	...
	CallTrackingDisplayLocation enums.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation `protobuf:"varint,7,opt,name=call_tracking_display_location,json=callTrackingDisplayLocation,proto3,enum=google.ads.googleads.v19.enums.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation" json:"call_tracking_display_location,omitempty"`
	// Output only. The type of the call.
	Type enums.CallTypeEnum_CallType `protobuf:"varint,8,opt,name=type,proto3,enum=google.ads.googleads.v19.enums.CallTypeEnum_CallType" json:"type,omitempty"`
	// Output only. The status of the call.
	CallStatus    enums.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus `protobuf:"varint,9,opt,name=call_status,json=callStatus,proto3,enum=google.ads.googleads.v19.enums.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus" json:"call_status,omitempty"`
...
func (x *CallView) Reset() {
	*x = CallView{}
	mi := &file_google_ads_googleads_v19_resources_call_view_proto_msgTypes[0]
...
func (*CallView) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_call_view_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v19_resources_call_view_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_resources_call_view_proto_rawDesc = string([]byte{
	...
	0x31, 0x39, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x61, 0x6c, 0x6c, 0x5f, 0x74, 0x72,
	...
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x31, 0x39, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x61,
	0x6c, 0x6c, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x3d, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x31, 0x39, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x67, 0x6f,
	...
	0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x56,
...
var (
	file_google_ads_googleads_v19_resources_call_view_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_resources_call_view_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_resources_call_view_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_resources_call_view_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_resources_call_view_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_call_view_proto_rawDesc), len(file_google_ads_googleads_v19_resources_call_view_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_resources_call_view_proto_rawDescData
}

var file_google_ads_googleads_v19_resources_call_view_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v19_resources_call_view_proto_goTypes = []any{
	(*CallView)(nil), // 0: google.ads.googleads.v19.resources.CallView
	(enums.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation)(0), // 1: google.ads.googleads.v19.enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation
	(enums.CallTypeEnum_CallType)(0),                                       // 2: google.ads.googleads.v19.enums.CallTypeEnum.CallType
	(enums.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus)(0),             // 3: google.ads.googleads.v19.enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus
}
var file_google_ads_googleads_v19_resources_call_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v19.resources.CallView.call_tracking_display_location:type_name -> google.ads.googleads.v19.enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation
	2, // 1: google.ads.googleads.v19.resources.CallView.type:type_name -> google.ads.googleads.v19.enums.CallTypeEnum.CallType
	3, // 2: google.ads.googleads.v19.resources.CallView.call_status:type_name -> google.ads.googleads.v19.enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus
...
func init() { file_google_ads_googleads_v19_resources_call_view_proto_init() }
func file_google_ads_googleads_v19_resources_call_view_proto_init() {
	if File_google_ads_googleads_v19_resources_call_view_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_call_view_proto_rawDesc), len(file_google_ads_googleads_v19_resources_call_view_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v19_resources_call_view_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_resources_call_view_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_resources_call_view_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_resources_call_view_proto = out.File
	file_google_ads_googleads_v19_resources_call_view_proto_goTypes = nil
	file_google_ads_googleads_v19_resources_call_view_proto_depIdxs = nil
}
