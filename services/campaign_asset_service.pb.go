...
func (x *MutateCampaignAssetsRequest) Reset() {
	*x = MutateCampaignAssetsRequest{}
	mi := &file_google_ads_googleads_v21_services_campaign_asset_service_proto_msgTypes[0]
...
func (*MutateCampaignAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignAssetOperation) Reset() {
	*x = CampaignAssetOperation{}
	mi := &file_google_ads_googleads_v21_services_campaign_asset_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CampaignAssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignAssetsResponse) Reset() {
	*x = MutateCampaignAssetsResponse{}
	mi := &file_google_ads_googleads_v21_services_campaign_asset_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignAssetResult) Reset() {
	*x = MutateCampaignAssetResult{}
	mi := &file_google_ads_googleads_v21_services_campaign_asset_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v21_services_campaign_asset_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDesc = string([]byte{
	...
	0x3a, 0x01, 0x2a, 0x22, 0x34, 0x2f, 0x76, 0x32, 0x31, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	...
	0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x19, 0x43, 0x61, 0x6d, 0x70,
...
var (
	file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_campaign_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v21_services_campaign_asset_service_proto_goTypes = []any{
	(*MutateCampaignAssetsRequest)(nil),                    // 0: google.ads.googleads.v21.services.MutateCampaignAssetsRequest
	(*CampaignAssetOperation)(nil),                         // 1: google.ads.googleads.v21.services.CampaignAssetOperation
	(*MutateCampaignAssetsResponse)(nil),                   // 2: google.ads.googleads.v21.services.MutateCampaignAssetsResponse
	(*MutateCampaignAssetResult)(nil),                      // 3: google.ads.googleads.v21.services.MutateCampaignAssetResult
	...
	(*resources.CampaignAsset)(nil),                        // 6: google.ads.googleads.v21.resources.CampaignAsset
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v21_services_campaign_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.services.MutateCampaignAssetsRequest.operations:type_name -> google.ads.googleads.v21.services.CampaignAssetOperation
	4, // 1: google.ads.googleads.v21.services.MutateCampaignAssetsRequest.response_content_type:type_name -> google.ads.googleads.v21.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v21.services.CampaignAssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v21.services.CampaignAssetOperation.create:type_name -> google.ads.googleads.v21.resources.CampaignAsset
	6, // 4: google.ads.googleads.v21.services.CampaignAssetOperation.update:type_name -> google.ads.googleads.v21.resources.CampaignAsset
	7, // 5: google.ads.googleads.v21.services.MutateCampaignAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v21.services.MutateCampaignAssetsResponse.results:type_name -> google.ads.googleads.v21.services.MutateCampaignAssetResult
	6, // 7: google.ads.googleads.v21.services.MutateCampaignAssetResult.campaign_asset:type_name -> google.ads.googleads.v21.resources.CampaignAsset
	0, // 8: google.ads.googleads.v21.services.CampaignAssetService.MutateCampaignAssets:input_type -> google.ads.googleads.v21.services.MutateCampaignAssetsRequest
	2, // 9: google.ads.googleads.v21.services.CampaignAssetService.MutateCampaignAssets:output_type -> google.ads.googleads.v21.services.MutateCampaignAssetsResponse
...
func init() { file_google_ads_googleads_v21_services_campaign_asset_service_proto_init() }
func file_google_ads_googleads_v21_services_campaign_asset_service_proto_init() {
	if File_google_ads_googleads_v21_services_campaign_asset_service_proto != nil {
		return
	}
	file_google_ads_googleads_v21_services_campaign_asset_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_campaign_asset_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_campaign_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_services_campaign_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_services_campaign_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_services_campaign_asset_service_proto = out.File
	file_google_ads_googleads_v21_services_campaign_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_campaign_asset_service_proto_depIdxs = nil
}
