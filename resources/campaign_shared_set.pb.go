...
type CampaignSharedSet struct {
	...
	Status        enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus `protobuf:"varint,2,opt,name=status,proto3,enum=google.ads.googleads.v19.enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus" json:"status,omitempty"`
...
func (x *CampaignSharedSet) Reset() {
	*x = CampaignSharedSet{}
	mi := &file_google_ads_googleads_v19_resources_campaign_shared_set_proto_msgTypes[0]
...
func (*CampaignSharedSet) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v19_resources_campaign_shared_set_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDesc = string([]byte{
	...
	0x2e, 0x76, 0x31, 0x39, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x16,
...
var (
	file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDesc), len(file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDescData
}

var file_google_ads_googleads_v19_resources_campaign_shared_set_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v19_resources_campaign_shared_set_proto_goTypes = []any{
	(*CampaignSharedSet)(nil),                                      // 0: google.ads.googleads.v19.resources.CampaignSharedSet
	(enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus)(0), // 1: google.ads.googleads.v19.enums.CampaignSharedSetStatusEnum.CampaignSharedSetStatus
}
var file_google_ads_googleads_v19_resources_campaign_shared_set_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v19.resources.CampaignSharedSet.status:type_name -> google.ads.googleads.v19.enums.CampaignSharedSetStatusEnum.CampaignSharedSetStatus
...
func init() { file_google_ads_googleads_v19_resources_campaign_shared_set_proto_init() }
func file_google_ads_googleads_v19_resources_campaign_shared_set_proto_init() {
	if File_google_ads_googleads_v19_resources_campaign_shared_set_proto != nil {
		return
	}
	file_google_ads_googleads_v19_resources_campaign_shared_set_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDesc), len(file_google_ads_googleads_v19_resources_campaign_shared_set_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v19_resources_campaign_shared_set_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_resources_campaign_shared_set_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_resources_campaign_shared_set_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_resources_campaign_shared_set_proto = out.File
	file_google_ads_googleads_v19_resources_campaign_shared_set_proto_goTypes = nil
	file_google_ads_googleads_v19_resources_campaign_shared_set_proto_depIdxs = nil
}
