...
const (
	CustomerLabelService_MutateCustomerLabels_FullMethodName = "/google.ads.googleads.v21.services.CustomerLabelService/MutateCustomerLabels"
)
...
// UnimplementedCustomerLabelServiceServer must be embedded to have
...
func (UnimplementedCustomerLabelServiceServer) testEmbeddedByValue()                              {}
...
func RegisterCustomerLabelServiceServer(s grpc.ServiceRegistrar, srv CustomerLabelServiceServer) {
	// If the following call pancis, it indicates UnimplementedCustomerLabelServiceServer was
...
var CustomerLabelService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v21/services/customer_label_service.proto",
}
