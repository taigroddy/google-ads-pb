...
// UnimplementedTravelAssetSuggestionServiceServer must be embedded to have
...
func (UnimplementedTravelAssetSuggestionServiceServer) testEmbeddedByValue() {}
...
func RegisterTravelAssetSuggestionServiceServer(s grpc.ServiceRegistrar, srv TravelAssetSuggestionServiceServer) {
	// If the following call pancis, it indicates UnimplementedTravelAssetSuggestionServiceServer was
