...
func (AdServingOptimizationStatusEnum_AdServingOptimizationStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_enumTypes[0].Descriptor()
}

func (AdServingOptimizationStatusEnum_AdServingOptimizationStatus) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_enumTypes[0]
}
...
func (AdServingOptimizationStatusEnum_AdServingOptimizationStatus) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AdServingOptimizationStatusEnum) Reset() {
	*x = AdServingOptimizationStatusEnum{}
	mi := &file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_msgTypes[0]
...
func (*AdServingOptimizationStatusEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDesc = string([]byte{
	...
	0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x20, 0x41, 0x64, 0x53,
...
var (
	file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDesc), len(file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDescData
}

var file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_goTypes = []any{
	(AdServingOptimizationStatusEnum_AdServingOptimizationStatus)(0), // 0: google.ads.googleads.v21.enums.AdServingOptimizationStatusEnum.AdServingOptimizationStatus
	(*AdServingOptimizationStatusEnum)(nil),                          // 1: google.ads.googleads.v21.enums.AdServingOptimizationStatusEnum
}
var file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_init() }
func file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_init() {
	if File_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDesc), len(file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_depIdxs,
	...
	File_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto = out.File
	file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_goTypes = nil
	file_google_ads_googleads_v21_enums_ad_serving_optimization_status_proto_depIdxs = nil
}
