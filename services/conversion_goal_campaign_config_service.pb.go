...
func (x *MutateConversionGoalCampaignConfigsRequest) Reset() {
	*x = MutateConversionGoalCampaignConfigsRequest{}
	mi := &file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_msgTypes[0]
...
func (*MutateConversionGoalCampaignConfigsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConversionGoalCampaignConfigOperation) Reset() {
	*x = ConversionGoalCampaignConfigOperation{}
	mi := &file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionGoalCampaignConfigOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateConversionGoalCampaignConfigsResponse) Reset() {
	*x = MutateConversionGoalCampaignConfigsResponse{}
	mi := &file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateConversionGoalCampaignConfigsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateConversionGoalCampaignConfigResult) Reset() {
	*x = MutateConversionGoalCampaignConfigResult{}
	mi := &file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateConversionGoalCampaignConfigResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDesc = string([]byte{
	...
	0x6e, 0x73, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x48, 0x3a, 0x01, 0x2a, 0x22, 0x43, 0x2f, 0x76, 0x32,
...
var (
	file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_goTypes = []any{
	(*MutateConversionGoalCampaignConfigsRequest)(nil),     // 0: google.ads.googleads.v21.services.MutateConversionGoalCampaignConfigsRequest
	(*ConversionGoalCampaignConfigOperation)(nil),          // 1: google.ads.googleads.v21.services.ConversionGoalCampaignConfigOperation
	(*MutateConversionGoalCampaignConfigsResponse)(nil),    // 2: google.ads.googleads.v21.services.MutateConversionGoalCampaignConfigsResponse
	(*MutateConversionGoalCampaignConfigResult)(nil),       // 3: google.ads.googleads.v21.services.MutateConversionGoalCampaignConfigResult
	...
	(*resources.ConversionGoalCampaignConfig)(nil),         // 6: google.ads.googleads.v21.resources.ConversionGoalCampaignConfig
}
var file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.services.MutateConversionGoalCampaignConfigsRequest.operations:type_name -> google.ads.googleads.v21.services.ConversionGoalCampaignConfigOperation
	4, // 1: google.ads.googleads.v21.services.MutateConversionGoalCampaignConfigsRequest.response_content_type:type_name -> google.ads.googleads.v21.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v21.services.ConversionGoalCampaignConfigOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v21.services.ConversionGoalCampaignConfigOperation.update:type_name -> google.ads.googleads.v21.resources.ConversionGoalCampaignConfig
	3, // 4: google.ads.googleads.v21.services.MutateConversionGoalCampaignConfigsResponse.results:type_name -> google.ads.googleads.v21.services.MutateConversionGoalCampaignConfigResult
	6, // 5: google.ads.googleads.v21.services.MutateConversionGoalCampaignConfigResult.conversion_goal_campaign_config:type_name -> google.ads.googleads.v21.resources.ConversionGoalCampaignConfig
	0, // 6: google.ads.googleads.v21.services.ConversionGoalCampaignConfigService.MutateConversionGoalCampaignConfigs:input_type -> google.ads.googleads.v21.services.MutateConversionGoalCampaignConfigsRequest
...
func file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_init() {
	if File_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto != nil {
		return
	}
	file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto = out.File
	file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_conversion_goal_campaign_config_service_proto_depIdxs = nil
}
