...
type FinalAppUrl struct {
	...
	OsType enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType `protobuf:"varint,1,opt,name=os_type,json=osType,proto3,enum=google.ads.googleads.v19.enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType" json:"os_type,omitempty"`
...
func (x *FinalAppUrl) Reset() {
	*x = FinalAppUrl{}
	mi := &file_google_ads_googleads_v19_common_final_app_url_proto_msgTypes[0]
...
func (*FinalAppUrl) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_common_final_app_url_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v19_common_final_app_url_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_common_final_app_url_proto_rawDesc = string([]byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x70, 0x70,
	...
	0x39, 0x5c, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xea, 0x02, 0x23, 0x47, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64,
	0x73, 0x3a, 0x3a, 0x56, 0x31, 0x39, 0x3a, 0x3a, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_google_ads_googleads_v19_common_final_app_url_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_common_final_app_url_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_common_final_app_url_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_common_final_app_url_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_common_final_app_url_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_common_final_app_url_proto_rawDesc), len(file_google_ads_googleads_v19_common_final_app_url_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_common_final_app_url_proto_rawDescData
}

var file_google_ads_googleads_v19_common_final_app_url_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v19_common_final_app_url_proto_goTypes = []any{
	(*FinalAppUrl)(nil), // 0: google.ads.googleads.v19.common.FinalAppUrl
	(enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType)(0), // 1: google.ads.googleads.v19.enums.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemType
}
var file_google_ads_googleads_v19_common_final_app_url_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v19.common.FinalAppUrl.os_type:type_name -> google.ads.googleads.v19.enums.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemType
...
func init() { file_google_ads_googleads_v19_common_final_app_url_proto_init() }
func file_google_ads_googleads_v19_common_final_app_url_proto_init() {
	if File_google_ads_googleads_v19_common_final_app_url_proto != nil {
		return
	}
	file_google_ads_googleads_v19_common_final_app_url_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_common_final_app_url_proto_rawDesc), len(file_google_ads_googleads_v19_common_final_app_url_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v19_common_final_app_url_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_common_final_app_url_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_common_final_app_url_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_common_final_app_url_proto = out.File
	file_google_ads_googleads_v19_common_final_app_url_proto_goTypes = nil
	file_google_ads_googleads_v19_common_final_app_url_proto_depIdxs = nil
}
