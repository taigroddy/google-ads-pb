...
func NewContentCreatorInsightsServiceClient(cc grpc.ClientConnInterface) ContentCreatorInsightsServiceClient {
	return &contentCreatorInsightsServiceClient{cc}
}

func (c *contentCreatorInsightsServiceClient) GenerateCreatorInsights(ctx context.Context, in *GenerateCreatorInsightsRequest, opts ...grpc.CallOption) (*GenerateCreatorInsightsResponse, error) {
...
// ContentCreatorInsightsServiceServer is the server API for ContentCreatorInsightsService service.
// All implementations must embed UnimplementedContentCreatorInsightsServiceServer
...
// UnimplementedContentCreatorInsightsServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
type UnimplementedContentCreatorInsightsServiceServer struct{}
...
func (UnimplementedContentCreatorInsightsServiceServer) testEmbeddedByValue() {}

// UnsafeContentCreatorInsightsServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to ContentCreatorInsightsServiceServer will
// result in compilation errors.
type UnsafeContentCreatorInsightsServiceServer interface {
	mustEmbedUnimplementedContentCreatorInsightsServiceServer()
}

func RegisterContentCreatorInsightsServiceServer(s grpc.ServiceRegistrar, srv ContentCreatorInsightsServiceServer) {
	// If the following call pancis, it indicates UnimplementedContentCreatorInsightsServiceServer was
	...
	s.RegisterService(&ContentCreatorInsightsService_ServiceDesc, srv)
}

func _ContentCreatorInsightsService_GenerateCreatorInsights_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateCreatorInsightsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ContentCreatorInsightsServiceServer).GenerateCreatorInsights(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ContentCreatorInsightsService_GenerateCreatorInsights_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ContentCreatorInsightsServiceServer).GenerateCreatorInsights(ctx, req.(*GenerateCreatorInsightsRequest))
	}
