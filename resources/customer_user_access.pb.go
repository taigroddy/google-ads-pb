...
func (x *CustomerUserAccess) Reset() {
	*x = CustomerUserAccess{}
	mi := &file_google_ads_googleads_v19_resources_customer_user_access_proto_msgTypes[0]
...
func (*CustomerUserAccess) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v19_resources_customer_user_access_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDesc = string([]byte{
	...
	0x39, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x17, 0x43, 0x75, 0x73,
...
var (
	file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDesc), len(file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDescData
}

var file_google_ads_googleads_v19_resources_customer_user_access_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v19_resources_customer_user_access_proto_goTypes = []any{
	(*CustomerUserAccess)(nil),           // 0: google.ads.googleads.v19.resources.CustomerUserAccess
	(enums.AccessRoleEnum_AccessRole)(0), // 1: google.ads.googleads.v19.enums.AccessRoleEnum.AccessRole
}
var file_google_ads_googleads_v19_resources_customer_user_access_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v19.resources.CustomerUserAccess.access_role:type_name -> google.ads.googleads.v19.enums.AccessRoleEnum.AccessRole
...
func init() { file_google_ads_googleads_v19_resources_customer_user_access_proto_init() }
func file_google_ads_googleads_v19_resources_customer_user_access_proto_init() {
	if File_google_ads_googleads_v19_resources_customer_user_access_proto != nil {
		return
	}
	file_google_ads_googleads_v19_resources_customer_user_access_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDesc), len(file_google_ads_googleads_v19_resources_customer_user_access_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v19_resources_customer_user_access_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_resources_customer_user_access_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_resources_customer_user_access_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_resources_customer_user_access_proto = out.File
	file_google_ads_googleads_v19_resources_customer_user_access_proto_goTypes = nil
	file_google_ads_googleads_v19_resources_customer_user_access_proto_depIdxs = nil
}
