...
func (ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_enumTypes[0].Descriptor()
}

func (ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_enumTypes[0]
}
...
func (ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ConversionValueRulePrimaryDimensionEnum) Reset() {
	*x = ConversionValueRulePrimaryDimensionEnum{}
	mi := &file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_msgTypes[0]
...
func (*ConversionValueRulePrimaryDimensionEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDesc = string([]byte{
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xf6,
	...
	0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0xca, 0x01, 0x0a, 0x23, 0x43,
	...
	0x4c, 0x54, 0x49, 0x50, 0x4c, 0x45, 0x10, 0x08, 0x12, 0x0d, 0x0a, 0x09, 0x49, 0x54, 0x49, 0x4e,
	0x45, 0x52, 0x41, 0x52, 0x59, 0x10, 0x09, 0x42, 0x82, 0x02, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x28,
...
var (
	file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDesc), len(file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDescData
}

var file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_goTypes = []any{
	(ConversionValueRulePrimaryDimensionEnum_ConversionValueRulePrimaryDimension)(0), // 0: google.ads.googleads.v21.enums.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension
	(*ConversionValueRulePrimaryDimensionEnum)(nil),                                  // 1: google.ads.googleads.v21.enums.ConversionValueRulePrimaryDimensionEnum
}
var file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_init() }
func file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_init() {
	if File_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDesc), len(file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto = out.File
	file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_goTypes = nil
	file_google_ads_googleads_v21_enums_conversion_value_rule_primary_dimension_proto_depIdxs = nil
}
