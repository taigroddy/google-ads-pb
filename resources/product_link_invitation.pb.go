...
type ProductLinkInvitation struct {
	...
	// This field is read only.
	Status enums.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v19.enums.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus" json:"status,omitempty"`
	...
	Type enums.LinkedProductTypeEnum_LinkedProductType `protobuf:"varint,6,opt,name=type,proto3,enum=google.ads.googleads.v19.enums.LinkedProductTypeEnum_LinkedProductType" json:"type,omitempty"`
...
func (x *ProductLinkInvitation) Reset() {
	*x = ProductLinkInvitation{}
	mi := &file_google_ads_googleads_v19_resources_product_link_invitation_proto_msgTypes[0]
...
func (*ProductLinkInvitation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDescGZIP(), []int{0}
}
...
func (x *HotelCenterLinkInvitationIdentifier) Reset() {
	*x = HotelCenterLinkInvitationIdentifier{}
	mi := &file_google_ads_googleads_v19_resources_product_link_invitation_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HotelCenterLinkInvitationIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDescGZIP(), []int{1}
}
...
func (x *MerchantCenterLinkInvitationIdentifier) Reset() {
	*x = MerchantCenterLinkInvitationIdentifier{}
	mi := &file_google_ads_googleads_v19_resources_product_link_invitation_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MerchantCenterLinkInvitationIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDescGZIP(), []int{2}
}
...
func (x *AdvertisingPartnerLinkInvitationIdentifier) Reset() {
	*x = AdvertisingPartnerLinkInvitationIdentifier{}
	mi := &file_google_ads_googleads_v19_resources_product_link_invitation_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdvertisingPartnerLinkInvitationIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v19_resources_product_link_invitation_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDesc = string([]byte{
	...
	0x73, 0x2e, 0x76, 0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x64,
...
var (
	file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDescData []byte
)

func file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDesc), len(file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDesc)))
	})
	return file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDescData
}

var file_google_ads_googleads_v19_resources_product_link_invitation_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v19_resources_product_link_invitation_proto_goTypes = []any{
	(*ProductLinkInvitation)(nil),                                          // 0: google.ads.googleads.v19.resources.ProductLinkInvitation
	(*HotelCenterLinkInvitationIdentifier)(nil),                            // 1: google.ads.googleads.v19.resources.HotelCenterLinkInvitationIdentifier
	(*MerchantCenterLinkInvitationIdentifier)(nil),                         // 2: google.ads.googleads.v19.resources.MerchantCenterLinkInvitationIdentifier
	(*AdvertisingPartnerLinkInvitationIdentifier)(nil),                     // 3: google.ads.googleads.v19.resources.AdvertisingPartnerLinkInvitationIdentifier
	(enums.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus)(0), // 4: google.ads.googleads.v19.enums.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus
	(enums.LinkedProductTypeEnum_LinkedProductType)(0),                     // 5: google.ads.googleads.v19.enums.LinkedProductTypeEnum.LinkedProductType
}
var file_google_ads_googleads_v19_resources_product_link_invitation_proto_depIdxs = []int32{
	4, // 0: google.ads.googleads.v19.resources.ProductLinkInvitation.status:type_name -> google.ads.googleads.v19.enums.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus
	5, // 1: google.ads.googleads.v19.resources.ProductLinkInvitation.type:type_name -> google.ads.googleads.v19.enums.LinkedProductTypeEnum.LinkedProductType
	1, // 2: google.ads.googleads.v19.resources.ProductLinkInvitation.hotel_center:type_name -> google.ads.googleads.v19.resources.HotelCenterLinkInvitationIdentifier
	2, // 3: google.ads.googleads.v19.resources.ProductLinkInvitation.merchant_center:type_name -> google.ads.googleads.v19.resources.MerchantCenterLinkInvitationIdentifier
	3, // 4: google.ads.googleads.v19.resources.ProductLinkInvitation.advertising_partner:type_name -> google.ads.googleads.v19.resources.AdvertisingPartnerLinkInvitationIdentifier
...
func init() { file_google_ads_googleads_v19_resources_product_link_invitation_proto_init() }
func file_google_ads_googleads_v19_resources_product_link_invitation_proto_init() {
	if File_google_ads_googleads_v19_resources_product_link_invitation_proto != nil {
		return
	}
	file_google_ads_googleads_v19_resources_product_link_invitation_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_google_ads_googleads_v19_resources_product_link_invitation_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDesc), len(file_google_ads_googleads_v19_resources_product_link_invitation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v19_resources_product_link_invitation_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v19_resources_product_link_invitation_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v19_resources_product_link_invitation_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v19_resources_product_link_invitation_proto = out.File
	file_google_ads_googleads_v19_resources_product_link_invitation_proto_goTypes = nil
	file_google_ads_googleads_v19_resources_product_link_invitation_proto_depIdxs = nil
}
