...
// Request message for
// [KeywordThemeConstantService.SuggestKeywordThemeConstants][google.ads.googleads.v21.services.KeywordThemeConstantService.SuggestKeywordThemeConstants].
...
func (x *SuggestKeywordThemeConstantsRequest) Reset() {
	*x = SuggestKeywordThemeConstantsRequest{}
	mi := &file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_msgTypes[0]
...
func (*SuggestKeywordThemeConstantsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SuggestKeywordThemeConstantsResponse) Reset() {
	*x = SuggestKeywordThemeConstantsResponse{}
	mi := &file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SuggestKeywordThemeConstantsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v21_services_keyword_theme_constant_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDesc = string([]byte{
	...
	0x32, 0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x3f, 0x67, 0x6f, 0x6f,
	...
	0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x75, 0x67, 0x67, 0x65,
	...
	0x2d, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x27, 0x3a, 0x01, 0x2a, 0x22, 0x22, 0x2f, 0x76, 0x32, 0x31,
...
var (
	file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_goTypes = []any{
	(*SuggestKeywordThemeConstantsRequest)(nil),  // 0: google.ads.googleads.v21.services.SuggestKeywordThemeConstantsRequest
	(*SuggestKeywordThemeConstantsResponse)(nil), // 1: google.ads.googleads.v21.services.SuggestKeywordThemeConstantsResponse
	(*resources.KeywordThemeConstant)(nil),       // 2: google.ads.googleads.v21.resources.KeywordThemeConstant
}
var file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v21.services.SuggestKeywordThemeConstantsResponse.keyword_theme_constants:type_name -> google.ads.googleads.v21.resources.KeywordThemeConstant
	0, // 1: google.ads.googleads.v21.services.KeywordThemeConstantService.SuggestKeywordThemeConstants:input_type -> google.ads.googleads.v21.services.SuggestKeywordThemeConstantsRequest
	1, // 2: google.ads.googleads.v21.services.KeywordThemeConstantService.SuggestKeywordThemeConstants:output_type -> google.ads.googleads.v21.services.SuggestKeywordThemeConstantsResponse
...
func init() { file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_init() }
func file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_init() {
	if File_google_ads_googleads_v21_services_keyword_theme_constant_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_services_keyword_theme_constant_service_proto = out.File
	file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_keyword_theme_constant_service_proto_depIdxs = nil
}
