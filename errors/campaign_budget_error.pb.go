...
const (
	...
	CampaignBudgetErrorEnum_BUDGET_BELOW_PER_DAY_MINIMUM CampaignBudgetErrorEnum_CampaignBudgetError = 22
)
...
var (
	CampaignBudgetErrorEnum_CampaignBudgetError_name = map[int32]string{
		...
		22: "BUDGET_BELOW_PER_DAY_MINIMUM",
	}
...
func (CampaignBudgetErrorEnum_CampaignBudgetError) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v21_errors_campaign_budget_error_proto_enumTypes[0].Descriptor()
}

func (CampaignBudgetErrorEnum_CampaignBudgetError) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v21_errors_campaign_budget_error_proto_enumTypes[0]
}
...
func (CampaignBudgetErrorEnum_CampaignBudgetError) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CampaignBudgetErrorEnum) Reset() {
	*x = CampaignBudgetErrorEnum{}
	mi := &file_google_ads_googleads_v21_errors_campaign_budget_error_proto_msgTypes[0]
...
func (*CampaignBudgetErrorEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v21_errors_campaign_budget_error_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDesc = string([]byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0xb9,
	0x07, 0x0a, 0x17, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x42, 0x75, 0x64, 0x67, 0x65,
	0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x9d, 0x07, 0x0a, 0x13, 0x43,
	...
	0x50, 0x45, 0x52, 0x49, 0x4f, 0x44, 0x10, 0x15, 0x12, 0x20, 0x0a, 0x1c, 0x42, 0x55, 0x44, 0x47,
	0x45, 0x54, 0x5f, 0x42, 0x45, 0x4c, 0x4f, 0x57, 0x5f, 0x50, 0x45, 0x52, 0x5f, 0x44, 0x41, 0x59,
	0x5f, 0x4d, 0x49, 0x4e, 0x49, 0x4d, 0x55, 0x4d, 0x10, 0x16, 0x42, 0xf8, 0x01, 0x0a, 0x23, 0x63,
	...
	0x72, 0x73, 0x42, 0x18, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x42, 0x75, 0x64, 0x67,
...
var (
	file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDesc), len(file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDescData
}

var file_google_ads_googleads_v21_errors_campaign_budget_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v21_errors_campaign_budget_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v21_errors_campaign_budget_error_proto_goTypes = []any{
	(CampaignBudgetErrorEnum_CampaignBudgetError)(0), // 0: google.ads.googleads.v21.errors.CampaignBudgetErrorEnum.CampaignBudgetError
	(*CampaignBudgetErrorEnum)(nil),                  // 1: google.ads.googleads.v21.errors.CampaignBudgetErrorEnum
}
var file_google_ads_googleads_v21_errors_campaign_budget_error_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v21_errors_campaign_budget_error_proto_init() }
func file_google_ads_googleads_v21_errors_campaign_budget_error_proto_init() {
	if File_google_ads_googleads_v21_errors_campaign_budget_error_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDesc), len(file_google_ads_googleads_v21_errors_campaign_budget_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_errors_campaign_budget_error_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_errors_campaign_budget_error_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v21_errors_campaign_budget_error_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v21_errors_campaign_budget_error_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_errors_campaign_budget_error_proto = out.File
	file_google_ads_googleads_v21_errors_campaign_budget_error_proto_goTypes = nil
	file_google_ads_googleads_v21_errors_campaign_budget_error_proto_depIdxs = nil
}
