...
func (x *MutateCustomerUserAccessInvitationRequest) Reset() {
	*x = MutateCustomerUserAccessInvitationRequest{}
	mi := &file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_msgTypes[0]
...
func (*MutateCustomerUserAccessInvitationRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerUserAccessInvitationOperation) Reset() {
	*x = CustomerUserAccessInvitationOperation{}
	mi := &file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerUserAccessInvitationOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerUserAccessInvitationResponse) Reset() {
	*x = MutateCustomerUserAccessInvitationResponse{}
	mi := &file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerUserAccessInvitationResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerUserAccessInvitationResult) Reset() {
	*x = MutateCustomerUserAccessInvitationResult{}
	mi := &file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerUserAccessInvitationResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDesc = string([]byte{
	...
	0x76, 0x32, 0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x75, 0x73,
...
var (
	file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_goTypes = []any{
	(*MutateCustomerUserAccessInvitationRequest)(nil),  // 0: google.ads.googleads.v21.services.MutateCustomerUserAccessInvitationRequest
	(*CustomerUserAccessInvitationOperation)(nil),      // 1: google.ads.googleads.v21.services.CustomerUserAccessInvitationOperation
	(*MutateCustomerUserAccessInvitationResponse)(nil), // 2: google.ads.googleads.v21.services.MutateCustomerUserAccessInvitationResponse
	(*MutateCustomerUserAccessInvitationResult)(nil),   // 3: google.ads.googleads.v21.services.MutateCustomerUserAccessInvitationResult
	(*resources.CustomerUserAccessInvitation)(nil),     // 4: google.ads.googleads.v21.resources.CustomerUserAccessInvitation
}
var file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v21.services.MutateCustomerUserAccessInvitationRequest.operation:type_name -> google.ads.googleads.v21.services.CustomerUserAccessInvitationOperation
	4, // 1: google.ads.googleads.v21.services.CustomerUserAccessInvitationOperation.create:type_name -> google.ads.googleads.v21.resources.CustomerUserAccessInvitation
	3, // 2: google.ads.googleads.v21.services.MutateCustomerUserAccessInvitationResponse.result:type_name -> google.ads.googleads.v21.services.MutateCustomerUserAccessInvitationResult
	0, // 3: google.ads.googleads.v21.services.CustomerUserAccessInvitationService.MutateCustomerUserAccessInvitation:input_type -> google.ads.googleads.v21.services.MutateCustomerUserAccessInvitationRequest
	2, // 4: google.ads.googleads.v21.services.CustomerUserAccessInvitationService.MutateCustomerUserAccessInvitation:output_type -> google.ads.googleads.v21.services.MutateCustomerUserAccessInvitationResponse
...
func init() {
	file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_init()
}
func file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_init() {
	if File_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto != nil {
		return
	}
	file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto = out.File
	file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_customer_user_access_invitation_service_proto_depIdxs = nil
}
