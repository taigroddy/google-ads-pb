...
func (x *GetGoogleAdsFieldRequest) Reset() {
	*x = GetGoogleAdsFieldRequest{}
	mi := &file_google_ads_googleads_v21_services_google_ads_field_service_proto_msgTypes[0]
...
func (*GetGoogleAdsFieldRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SearchGoogleAdsFieldsRequest) Reset() {
	*x = SearchGoogleAdsFieldsRequest{}
	mi := &file_google_ads_googleads_v21_services_google_ads_field_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchGoogleAdsFieldsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *SearchGoogleAdsFieldsResponse) Reset() {
	*x = SearchGoogleAdsFieldsResponse{}
	mi := &file_google_ads_googleads_v21_services_google_ads_field_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchGoogleAdsFieldsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v21_services_google_ads_field_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDesc = string([]byte{
	...
	0x76, 0x32, 0x31, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x6e, 0x61,
	...
	0x02, 0x20, 0x3a, 0x01, 0x2a, 0x22, 0x1b, 0x2f, 0x76, 0x32, 0x31, 0x2f, 0x67, 0x6f, 0x6f, 0x67,
...
var (
	file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDescData
}

var file_google_ads_googleads_v21_services_google_ads_field_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v21_services_google_ads_field_service_proto_goTypes = []any{
	(*GetGoogleAdsFieldRequest)(nil),      // 0: google.ads.googleads.v21.services.GetGoogleAdsFieldRequest
	(*SearchGoogleAdsFieldsRequest)(nil),  // 1: google.ads.googleads.v21.services.SearchGoogleAdsFieldsRequest
	(*SearchGoogleAdsFieldsResponse)(nil), // 2: google.ads.googleads.v21.services.SearchGoogleAdsFieldsResponse
	(*resources.GoogleAdsField)(nil),      // 3: google.ads.googleads.v21.resources.GoogleAdsField
}
var file_google_ads_googleads_v21_services_google_ads_field_service_proto_depIdxs = []int32{
	3, // 0: google.ads.googleads.v21.services.SearchGoogleAdsFieldsResponse.results:type_name -> google.ads.googleads.v21.resources.GoogleAdsField
	0, // 1: google.ads.googleads.v21.services.GoogleAdsFieldService.GetGoogleAdsField:input_type -> google.ads.googleads.v21.services.GetGoogleAdsFieldRequest
	1, // 2: google.ads.googleads.v21.services.GoogleAdsFieldService.SearchGoogleAdsFields:input_type -> google.ads.googleads.v21.services.SearchGoogleAdsFieldsRequest
	3, // 3: google.ads.googleads.v21.services.GoogleAdsFieldService.GetGoogleAdsField:output_type -> google.ads.googleads.v21.resources.GoogleAdsField
	2, // 4: google.ads.googleads.v21.services.GoogleAdsFieldService.SearchGoogleAdsFields:output_type -> google.ads.googleads.v21.services.SearchGoogleAdsFieldsResponse
...
func init() { file_google_ads_googleads_v21_services_google_ads_field_service_proto_init() }
func file_google_ads_googleads_v21_services_google_ads_field_service_proto_init() {
	if File_google_ads_googleads_v21_services_google_ads_field_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDesc), len(file_google_ads_googleads_v21_services_google_ads_field_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v21_services_google_ads_field_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_services_google_ads_field_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_services_google_ads_field_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_services_google_ads_field_service_proto = out.File
	file_google_ads_googleads_v21_services_google_ads_field_service_proto_goTypes = nil
	file_google_ads_googleads_v21_services_google_ads_field_service_proto_depIdxs = nil
}
