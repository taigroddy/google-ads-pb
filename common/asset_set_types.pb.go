...
func (x *LocationSet) Reset() {
	*x = LocationSet{}
	mi := &file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[0]
...
func (*LocationSet) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescGZIP(), []int{0}
}
...
func (x *BusinessProfileLocationSet) Reset() {
	*x = BusinessProfileLocationSet{}
	mi := &file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BusinessProfileLocationSet) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescGZIP(), []int{1}
}
...
type ChainSet struct {
	...
	// advertiser.
	RelationshipType enums.ChainRelationshipTypeEnum_ChainRelationshipType `protobuf:"varint,1,opt,name=relationship_type,json=relationshipType,proto3,enum=google.ads.googleads.v21.enums.ChainRelationshipTypeEnum_ChainRelationshipType" json:"relationship_type,omitempty"`
...
func (x *ChainSet) Reset() {
	*x = ChainSet{}
	mi := &file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChainSet) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescGZIP(), []int{2}
}
...
func (x *ChainFilter) Reset() {
	*x = ChainFilter{}
	mi := &file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChainFilter) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescGZIP(), []int{3}
}
...
func (x *MapsLocationSet) Reset() {
	*x = MapsLocationSet{}
	mi := &file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MapsLocationSet) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescGZIP(), []int{4}
}
...
func (x *MapsLocationInfo) Reset() {
	*x = MapsLocationInfo{}
	mi := &file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MapsLocationInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescGZIP(), []int{5}
}
...
func (x *BusinessProfileLocationGroup) Reset() {
	*x = BusinessProfileLocationGroup{}
	mi := &file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BusinessProfileLocationGroup) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescGZIP(), []int{6}
}
...
func (x *DynamicBusinessProfileLocationGroupFilter) Reset() {
	*x = DynamicBusinessProfileLocationGroupFilter{}
	mi := &file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DynamicBusinessProfileLocationGroupFilter) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescGZIP(), []int{7}
}
...
type BusinessProfileBusinessNameFilter struct {
	...
	FilterType    enums.LocationStringFilterTypeEnum_LocationStringFilterType `protobuf:"varint,2,opt,name=filter_type,json=filterType,proto3,enum=google.ads.googleads.v21.enums.LocationStringFilterTypeEnum_LocationStringFilterType" json:"filter_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BusinessProfileBusinessNameFilter) Reset() {
	*x = BusinessProfileBusinessNameFilter{}
	mi := &file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BusinessProfileBusinessNameFilter) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescGZIP(), []int{8}
}
...
func (x *ChainLocationGroup) Reset() {
	*x = ChainLocationGroup{}
	mi := &file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChainLocationGroup) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescGZIP(), []int{9}
}
...
var File_google_ads_googleads_v21_common_asset_set_types_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v21_common_asset_set_types_proto_rawDesc = string([]byte{
	...
	0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x1a, 0x3c, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2f, 0x76,
	0x32, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x5f, 0x72,
	...
	0x2e, 0x76, 0x32, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x74,
	...
	0x76, 0x32, 0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x68, 0x61, 0x69, 0x6e,
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x42, 0x75,
	...
	0x32, 0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x46,
	...
	0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x32, 0x31, 0x2e, 0x43, 0x6f,
	...
	0x3a, 0x56, 0x32, 0x31, 0x3a, 0x3a, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescData []byte
)

func file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_common_asset_set_types_proto_rawDesc), len(file_google_ads_googleads_v21_common_asset_set_types_proto_rawDesc)))
	})
	return file_google_ads_googleads_v21_common_asset_set_types_proto_rawDescData
}

var file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_google_ads_googleads_v21_common_asset_set_types_proto_goTypes = []any{
	(*LocationSet)(nil),                                              // 0: google.ads.googleads.v21.common.LocationSet
	(*BusinessProfileLocationSet)(nil),                               // 1: google.ads.googleads.v21.common.BusinessProfileLocationSet
	(*ChainSet)(nil),                                                 // 2: google.ads.googleads.v21.common.ChainSet
	(*ChainFilter)(nil),                                              // 3: google.ads.googleads.v21.common.ChainFilter
	(*MapsLocationSet)(nil),                                          // 4: google.ads.googleads.v21.common.MapsLocationSet
	(*MapsLocationInfo)(nil),                                         // 5: google.ads.googleads.v21.common.MapsLocationInfo
	(*BusinessProfileLocationGroup)(nil),                             // 6: google.ads.googleads.v21.common.BusinessProfileLocationGroup
	(*DynamicBusinessProfileLocationGroupFilter)(nil),                // 7: google.ads.googleads.v21.common.DynamicBusinessProfileLocationGroupFilter
	(*BusinessProfileBusinessNameFilter)(nil),                        // 8: google.ads.googleads.v21.common.BusinessProfileBusinessNameFilter
	(*ChainLocationGroup)(nil),                                       // 9: google.ads.googleads.v21.common.ChainLocationGroup
	(enums.LocationOwnershipTypeEnum_LocationOwnershipType)(0),       // 10: google.ads.googleads.v21.enums.LocationOwnershipTypeEnum.LocationOwnershipType
	(enums.ChainRelationshipTypeEnum_ChainRelationshipType)(0),       // 11: google.ads.googleads.v21.enums.ChainRelationshipTypeEnum.ChainRelationshipType
	(enums.LocationStringFilterTypeEnum_LocationStringFilterType)(0), // 12: google.ads.googleads.v21.enums.LocationStringFilterTypeEnum.LocationStringFilterType
}
var file_google_ads_googleads_v21_common_asset_set_types_proto_depIdxs = []int32{
	10, // 0: google.ads.googleads.v21.common.LocationSet.location_ownership_type:type_name -> google.ads.googleads.v21.enums.LocationOwnershipTypeEnum.LocationOwnershipType
	1,  // 1: google.ads.googleads.v21.common.LocationSet.business_profile_location_set:type_name -> google.ads.googleads.v21.common.BusinessProfileLocationSet
	2,  // 2: google.ads.googleads.v21.common.LocationSet.chain_location_set:type_name -> google.ads.googleads.v21.common.ChainSet
	4,  // 3: google.ads.googleads.v21.common.LocationSet.maps_location_set:type_name -> google.ads.googleads.v21.common.MapsLocationSet
	11, // 4: google.ads.googleads.v21.common.ChainSet.relationship_type:type_name -> google.ads.googleads.v21.enums.ChainRelationshipTypeEnum.ChainRelationshipType
	3,  // 5: google.ads.googleads.v21.common.ChainSet.chains:type_name -> google.ads.googleads.v21.common.ChainFilter
	5,  // 6: google.ads.googleads.v21.common.MapsLocationSet.maps_locations:type_name -> google.ads.googleads.v21.common.MapsLocationInfo
	7,  // 7: google.ads.googleads.v21.common.BusinessProfileLocationGroup.dynamic_business_profile_location_group_filter:type_name -> google.ads.googleads.v21.common.DynamicBusinessProfileLocationGroupFilter
	8,  // 8: google.ads.googleads.v21.common.DynamicBusinessProfileLocationGroupFilter.business_name_filter:type_name -> google.ads.googleads.v21.common.BusinessProfileBusinessNameFilter
	12, // 9: google.ads.googleads.v21.common.BusinessProfileBusinessNameFilter.filter_type:type_name -> google.ads.googleads.v21.enums.LocationStringFilterTypeEnum.LocationStringFilterType
	3,  // 10: google.ads.googleads.v21.common.ChainLocationGroup.dynamic_chain_location_group_filters:type_name -> google.ads.googleads.v21.common.ChainFilter
...
func init() { file_google_ads_googleads_v21_common_asset_set_types_proto_init() }
func file_google_ads_googleads_v21_common_asset_set_types_proto_init() {
	if File_google_ads_googleads_v21_common_asset_set_types_proto != nil {
		return
	}
	file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[0].OneofWrappers = []any{
		(*LocationSet_BusinessProfileLocationSet)(nil),
		(*LocationSet_ChainLocationSet)(nil),
		(*LocationSet_MapsLocationSet)(nil),
	}
	file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v21_common_asset_set_types_proto_rawDesc), len(file_google_ads_googleads_v21_common_asset_set_types_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v21_common_asset_set_types_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v21_common_asset_set_types_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v21_common_asset_set_types_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v21_common_asset_set_types_proto = out.File
	file_google_ads_googleads_v21_common_asset_set_types_proto_goTypes = nil
	file_google_ads_googleads_v21_common_asset_set_types_proto_depIdxs = nil
}
