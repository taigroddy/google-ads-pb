...
// internalBiddingSeasonalityAdjustmentClient is an interface that defines the methods available from Google Ads API.
...
func (c *biddingSeasonalityAdjustmentGRPCClient) MutateBiddingSeasonalityAdjustments(ctx context.Context, req *servicespb.MutateBiddingSeasonalityAdjustmentsRequest, opts ...gax.CallOption) (*servicespb.MutateBiddingSeasonalityAdjustmentsResponse, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = executeRPC(ctx, c.biddingSeasonalityAdjustmentClient.MutateBiddingSeasonalityAdjustments, req, settings.GRPC, c.logger, "MutateBiddingSeasonalityAdjustments")
		return err
	}, opts...)
	if err != nil {
		return nil, err
