...
const (
	PaymentsAccountService_ListPaymentsAccounts_FullMethodName = "/google.ads.googleads.v21.services.PaymentsAccountService/ListPaymentsAccounts"
)
...
// UnimplementedPaymentsAccountServiceServer must be embedded to have
...
func (UnimplementedPaymentsAccountServiceServer) testEmbeddedByValue() {}
...
func RegisterPaymentsAccountServiceServer(s grpc.ServiceRegistrar, srv PaymentsAccountServiceServer) {
	// If the following call pancis, it indicates UnimplementedPaymentsAccountServiceServer was
...
var PaymentsAccountService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v21.services.PaymentsAccountService",
	...
	Metadata: "google/ads/googleads/v21/services/payments_account_service.proto",
}
